...
"[project]/app/app/api/book/me/saved/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$app$2f$api$2f$book$2f$_lib$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withBookApiErrors"])(req, async ()=>{
        ...
        const saved = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$app$2f$api$2f$book$2f$_lib$2f$repo$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listSavedBooks"])(tableName, user.sub);
...
async function PUT(req) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$app$2f$api$2f$book$2f$_lib$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withBookApiErrors"])(req, async ()=>{
        ...
        const body = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$app$2f$api$2f$book$2f$_lib$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireBodyObject"])(bodyRaw);
        const bookId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$app$2f$api$2f$book$2f$_lib$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireString"])(body.bookId, "bookId", {
            maxLength: 120
        });
        const source = typeof body.source === "string" && body.source.trim() ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$app$2f$api$2f$book$2f$_lib$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireString"])(body.source, "source", {
            maxLength: 120
        }) : undefined;
        const priority = body.priority === undefined ? undefined : (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$app$2f$api$2f$book$2f$_lib$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireInteger"])(body.priority, "priority", {
            min: 0,
            max: 1000
        });
        const pinned = body.pinned === true;
        const saved = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$app$2f$api$2f$book$2f$_lib$2f$repo$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["putSavedBook"])(tableName, {
            userId: user.sub,
            bookId,
            source,
            priority,
...
async function DELETE(req) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$app$2f$api$2f$book$2f$_lib$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withBookApiErrors"])(req, async ()=>{
        ...
        const bookId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$app$2f$api$2f$book$2f$_lib$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireString"])(url.searchParams.get("bookId"), "bookId", {
            maxLength: 120
        });
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$app$2f$api$2f$book$2f$_lib$2f$repo$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deleteSavedBook"])(tableName, user.sub, bookId);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$app$2f$api$2f$book$2f$_lib$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["bookOk"])({
            ok: true
        });
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__193cf88e._.js.map