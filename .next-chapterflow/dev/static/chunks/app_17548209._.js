...
"[project]/app/book/data/mockChapters.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "getBookChaptersBundle",
    ()=>getBookChaptersBundle,
    "getBookPackageEdition",
    ()=>getBookPackageEdition,
    "getChapterById",
    ()=>getChapterById,
    "getChapterByOrder",
...
function splitSentences(value) {
    if (!value) return [];
    return cleanText(value).split(/(?<=[.!?])\s+/).map((sentence)=>cleanText(sentence)).filter(Boolean);
}
function dedupe(values) {
    return Array.from(new Set(values.map((value)=>cleanText(value)).filter(Boolean)));
}
function variantKeysForFamily(variantFamily) {
...
function getVariantContent(chapter, family, depth) {
...
function variantTakeaways(variant) {
    if (!variant) return [];
    return dedupe([
        ...variant.takeaways ?? [],
...
function variantPractice(variant) {
    if (!variant) return [];
    return dedupe(variant.practice ?? []);
}
function variantSummaryBullets(variant) {
    if (!variant) return [];
    return Array.isArray(variant.summaryBullets) && variant.summaryBullets.length ? dedupe(variant.summaryBullets) : splitSentences(variant.importantSummary);
}
function buildSummaryBullets(chapter, family, depth) {
    ...
    const supplements = depth === "simple" ? dedupe([
        ...exampleInsights.slice(0, 2),
        ...variantTakeaways(simple)
    ]) : depth === "standard" ? dedupe([
    ...
    return dedupe([
        ...base,
        ...supplements
    ]).slice(0, DEPTH_TARGETS[depth]);
}
function buildTakeaways(chapter, family) {
...
function buildKeyQuote(chapter, family) {
...
function buildRecap(chapter, family) {
    const preferred = getVariantContent(chapter, family, "deeper");
    const fallback = getVariantContent(chapter, family, "standard");
...
function buildQuizByDepth(questions) {
    return {
...
function buildQuizExplanation(chapter, questionPrompt, correctAnswer, family) {
...
function estimatePages(bookPackage) {
    const presentation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$data$2f$bookPackages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBookPackagePresentation"])(bookPackage.book.bookId);
...
function buildBundle(bookPackage) {
    const family = bookPackage.book.variantFamily;
    const chapters = [
        ...bookPackage.chapters
    ].sort((left, right)=>left.number - right.number).map((chapter)=>{
        const quiz = chapter.quiz.questions.map((question)=>{
            const options = normalizeChoices(question.choices);
            const correctIndex = Math.max(0, Math.min(options.length - 1, question.correctIndex ?? question.correctAnswerIndex ?? 0));
            return {
                id: question.questionId,
                prompt: cleanText(question.prompt),
                options,
                correctIndex,
                explanation: question.explanation?.trim() || buildQuizExplanation(chapter, question.prompt, options[correctIndex], family)
            };
        });
        return {
...
const CHAPTERS_BY_BOOK_ID = Object.fromEntries(_c1 = __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$data$2f$bookPackages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BOOK_PACKAGES"].map(_c = (pkg)=>[
        pkg.book.bookId,
        buildBundle(pkg)
    ]));
_c2 = CHAPTERS_BY_BOOK_ID;
const EMPTY_BUNDLE = {
    pages: 0,
    chapters: []
};
function getBookChaptersBundle(bookId) {
    return CHAPTERS_BY_BOOK_ID[bookId] ?? EMPTY_BUNDLE;
}
function getChapterById(bookId, chapterId) {
    return getBookChaptersBundle(bookId).chapters.find((chapter)=>chapter.id === chapterId);
}
function getChapterByOrder(bookId, order) {
    return getBookChaptersBundle(bookId).chapters.find((chapter)=>chapter.order === order);
}
function getBookPackageEdition(bookId) {
    const bookPackage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$data$2f$bookPackages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBookPackageById"])(bookId);
...
var _c, _c1, _c2;
__turbopack_context__.k.register(_c, "CHAPTERS_BY_BOOK_ID$Object.fromEntries$BOOK_PACKAGES.map");
__turbopack_context__.k.register(_c1, "CHAPTERS_BY_BOOK_ID$Object.fromEntries");
__turbopack_context__.k.register(_c2, "CHAPTERS_BY_BOOK_ID");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/app/book/data/mockProgress.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$data$2f$mockChapters$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/book/data/mockChapters.ts [app-client] (ecmascript)");
;
;
const QUICK_REVIEW_PROMPTS = [
...
function buildRecentBooks(selectedBookIds) {
    const selected = selectedBookIds.filter((id)=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$data$2f$booksCatalog$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BOOKS_CATALOG"].some((book)=>book.id === id));
    const fallback = __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$data$2f$booksCatalog$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BOOKS_CATALOG"].map((book)=>book.id).filter((id)=>!selected.includes(id));
    const ordered = [
        ...selected,
        ...fallback
    ].slice(0, 5);
    return ordered.map((bookId)=>{
        const chapters = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$data$2f$mockChapters$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBookChaptersBundle"])(bookId).chapters;
...
function buildTodaySessionTasks(currentChapter) {
    return [
        {
            id: "review",
...
function buildBadges(streakDays) {
    return [
        {
            id: "first-chapter",
            name: "First Chapter",
...
function buildDailyInsight(bookTitle) {
    return {
        ...
        action: "Try one simple context opener today, then stay on the same topic with a real follow-up question."
    };
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
...
"[project]/app/book/_lib/book-api.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"use client";
class BookClientError extends Error {
    status;
    code;
...
async function fetchBookJson(input, init) {
    ...
    if (!response.ok) {
        const message = payload && typeof payload === "object" && "error" in payload && payload.error && typeof payload.error === "object" && "message" in payload.error && typeof payload.error.message === "string" ? payload.error.message : `Request failed with status ${response.status}`;
...
"[project]/app/book/_lib/reader-storage.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "BOOK_PROGRESS_STORAGE_PREFIX",
    ()=>BOOK_PROGRESS_STORAGE_PREFIX,
...
"use client";
const BOOK_PROGRESS_STORAGE_PREFIX = "book-accelerator:book-progress:v3";
const CHAPTER_READER_STORAGE_PREFIX = "book-accelerator:chapter-reader:v1";
function getBookProgressStorageKey(bookId) {
    return `${BOOK_PROGRESS_STORAGE_PREFIX}:${bookId}`;
}
function getChapterReaderStorageKey(bookId, chapterId) {
    return `${CHAPTER_READER_STORAGE_PREFIX}:${bookId}:${chapterId}`;
}
function isValidTimestamp(value) {
    return Number.isFinite(new Date(value).getTime());
}
function parseStoredBookProgress(raw) {
    if (!raw) return null;
    try {
        const parsed = JSON.parse(raw);
        return {
            currentChapterId: typeof parsed.currentChapterId === "string" ? parsed.currentChapterId : "",
            completedChapterIds: Array.isArray(parsed.completedChapterIds) ? parsed.completedChapterIds.filter((value)=>typeof value === "string") : [],
            unlockedChapterIds: Array.isArray(parsed.unlockedChapterIds) ? parsed.unlockedChapterIds.filter((value)=>typeof value === "string") : [],
            chapterScores: parsed.chapterScores && typeof parsed.chapterScores === "object" ? Object.fromEntries(Object.entries(parsed.chapterScores).filter(([chapterId, score])=>typeof chapterId === "string" && Number.isFinite(Number(score)))) : {},
            chapterCompletedAt: parsed.chapterCompletedAt && typeof parsed.chapterCompletedAt === "object" ? Object.fromEntries(Object.entries(parsed.chapterCompletedAt).filter(([chapterId, completedAt])=>typeof chapterId === "string" && typeof completedAt === "string" && completedAt.trim() && isValidTimestamp(completedAt))) : {},
            lastReadChapterId: typeof parsed.lastReadChapterId === "string" ? parsed.lastReadChapterId : "",
            lastOpenedAt: typeof parsed.lastOpenedAt === "string" && parsed.lastOpenedAt.trim() ? parsed.lastOpenedAt : new Date(0).toISOString()
        };
    } catch  {
        return null;
    }
}
function parseStoredReaderState(raw) {
    if (!raw) return null;
    try {
        const parsed = JSON.parse(raw);
        return {
            activeTab: parsed.activeTab === "summary" || parsed.activeTab === "examples" || parsed.activeTab === "quiz" ? parsed.activeTab : "summary",
            readingDepth: parsed.readingDepth === "simple" || parsed.readingDepth === "standard" || parsed.readingDepth === "deeper" ? parsed.readingDepth : "deeper",
            exampleFilter: parsed.exampleFilter === "all" || parsed.exampleFilter === "personal" || parsed.exampleFilter === "school" || parsed.exampleFilter === "work" ? parsed.exampleFilter : "all",
            quizAnswers: parsed.quizAnswers && typeof parsed.quizAnswers === "object" ? Object.fromEntries(Object.entries(parsed.quizAnswers).filter(([questionId, answer])=>typeof questionId === "string" && Number.isFinite(Number(answer)))) : {},
            quizResult: parsed.quizResult && typeof parsed.quizResult === "object" ? {
            ...
            fontScale: parsed.fontScale === "sm" || parsed.fontScale === "md" || parsed.fontScale === "lg" ? parsed.fontScale : "md",
            showRecap: typeof parsed.showRecap === "boolean" ? parsed.showRecap : false,
            explanationOpen: parsed.explanationOpen && typeof parsed.explanationOpen === "object" ? Object.fromEntries(Object.entries(parsed.explanationOpen).filter(([questionId, open])=>typeof questionId === "string" && typeof open === "boolean")) : {}
        };
    } catch  {
        return null;
    }
...
"[project]/app/book/data/mockBadges.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function progressForBadge(id, stats) {
    switch(id){
        case "first-chapter":
            return {
                current: stats.totalCompletedChapters,
                target: 1,
                label: `${Math.min(stats.totalCompletedChapters, 1)} of 1 chapter`
            };
        case "first-quiz-pass":
            return {
                current: stats.quizzesPassed,
                target: 1,
                label: `${Math.min(stats.quizzesPassed, 1)} of 1 quiz`
            };
        case "first-note":
            return {
                current: stats.notesCount,
                target: 1,
                label: `${Math.min(stats.notesCount, 1)} of 1 note`
            };
        case "first-book-started":
            return {
                current: stats.startedBooks,
                target: 1,
                label: `${Math.min(stats.startedBooks, 1)} of 1 book`
            };
        case "first-goal-hit":
            return {
                current: stats.completedGoalDays,
                target: 1,
                label: `${Math.min(stats.completedGoalDays, 1)} of 1 day`
            };
        case "first-examples-viewed":
            return {
                current: stats.examplesViewedChapters,
                target: 1,
                label: `${Math.min(stats.examplesViewedChapters, 1)} of 1 chapter`
            };
        case "first-standard-depth":
            return {
                current: stats.chaptersStandardCompleted + stats.chaptersDeeperCompleted,
                target: 1,
                label: `${Math.min(stats.chaptersStandardCompleted + stats.chaptersDeeperCompleted, 1)} of 1 chapter`
            };
        case "streak-3":
            return {
                current: stats.longestStreak,
                target: 3,
                label: `${Math.min(stats.longestStreak, 3)} of 3 days`
            };
        case "streak-7":
            return {
                current: stats.longestStreak,
                target: 7,
                label: `${Math.min(stats.longestStreak, 7)} of 7 days`
            };
        case "streak-14":
            return {
                current: stats.longestStreak,
                target: 14,
                label: `${Math.min(stats.longestStreak, 14)} of 14 days`
            };
        case "streak-30":
            return {
                current: stats.longestStreak,
                target: 30,
                label: `${Math.min(stats.longestStreak, 30)} of 30 days`
            };
        case "goal-5":
            return {
                current: stats.completedGoalDays,
                target: 5,
                label: `${Math.min(stats.completedGoalDays, 5)} of 5 days`
            };
        case "goal-10":
            return {
                current: stats.completedGoalDays,
                target: 10,
                label: `${Math.min(stats.completedGoalDays, 10)} of 10 days`
            };
        case "week-reader":
            return {
                current: stats.activeWeeks,
                target: 4,
                label: `${Math.min(stats.activeWeeks, 4)} of 4 weeks`
            };
        case "weekend-weekday":
            return {
                current: Math.min(stats.weekendActiveDays, 4) + Math.min(stats.weekdayActiveDays, 10),
                target: 14,
                label: `${Math.min(stats.weekendActiveDays, 4)} weekend days and ${Math.min(stats.weekdayActiveDays, 10)} weekdays`
            };
        case "comeback-reader":
            return {
                current: stats.recoveredAfterMiss,
                target: 1,
                label: `${Math.min(stats.recoveredAfterMiss, 1)} of 1 return`
            };
        case "standard-five":
            return {
                current: stats.chaptersStandardCompleted,
                target: 5,
                label: `${Math.min(stats.chaptersStandardCompleted, 5)} of 5 chapters`
            };
        case "deeper-five":
            return {
                current: stats.chaptersDeeperCompleted,
                target: 5,
                label: `${Math.min(stats.chaptersDeeperCompleted, 5)} of 5 chapters`
            };
        case "mode-explorer":
            return {
                current: stats.usedAllReadingModes ? 3 : Number(stats.chaptersSimpleCompleted > 0) + Number(stats.chaptersStandardCompleted > 0) + Number(stats.chaptersDeeperCompleted > 0),
                target: 3,
                label: `${Number(stats.chaptersSimpleCompleted > 0) + Number(stats.chaptersStandardCompleted > 0) + Number(stats.chaptersDeeperCompleted > 0)} of 3 modes`
            };
        case "focus-finish":
            return {
                current: stats.chaptersCompletedWithFocusMode,
                target: 1,
                label: `${Math.min(stats.chaptersCompletedWithFocusMode, 1)} of 1 chapter`
            };
        case "annotated-run":
            return {
                current: stats.completedChaptersWithNotes,
                target: 10,
                label: `${Math.min(stats.completedChaptersWithNotes, 10)} of 10 chapters`
            };
        case "deeper-book":
            return {
                current: stats.completedBooksInDeeperMode,
                target: 1,
                label: `${Math.min(stats.completedBooksInDeeperMode, 1)} of 1 book`
            };
        case "perfect-one":
            return {
                current: stats.perfectQuizCount,
                target: 1,
                label: `${Math.min(stats.perfectQuizCount, 1)} of 1 perfect score`
            };
        case "perfect-three":
            return {
                current: stats.perfectQuizCount,
                target: 3,
                label: `${Math.min(stats.perfectQuizCount, 3)} of 3 perfect scores`
            };
        case "quiz-pass-10":
            return {
                current: stats.quizzesPassed,
                target: 10,
                label: `${Math.min(stats.quizzesPassed, 10)} of 10 quizzes`
            };
        case "quiz-pass-25":
            return {
                current: stats.quizzesPassed,
                target: 25,
                label: `${Math.min(stats.quizzesPassed, 25)} of 25 quizzes`
            };
        case "deeper-pass":
            return {
                current: stats.quizzesPassedInDeeperMode,
                target: 1,
                label: `${Math.min(stats.quizzesPassedInDeeperMode, 1)} of 1 quiz`
            };
        case "score-80-ten":
            return {
                current: stats.quizCount >= 10 ? Math.min(stats.avgQuizScore, 80) : Math.min(stats.quizCount, 10) * 8,
                target: 80,
                label: stats.quizCount >= 10 ? `${Math.min(stats.avgQuizScore, 80)} of 80 average score` : `${stats.quizCount} of 10 quizzes tracked`
            };
        case "hundred-answers":
            return {
                current: stats.totalQuizQuestionsAnswered,
                target: 100,
                label: `${Math.min(stats.totalQuizQuestionsAnswered, 100)} of 100 answers`
            };
        case "mastery-three-books":
            return {
                current: stats.distinctQuizBooks,
                target: 3,
                label: `${Math.min(stats.distinctQuizBooks, 3)} of 3 books`
            };
        case "recap-finish":
            return {
                current: stats.recapCompletions,
                target: 1,
                label: `${Math.min(stats.recapCompletions, 1)} of 1 recap`
            };
        case "first-book":
            return {
                current: stats.completedBooks,
                target: 1,
                label: `${Math.min(stats.completedBooks, 1)} of 1 book`
            };
        case "three-books":
            return {
                current: stats.completedBooks,
                target: 3,
                label: `${Math.min(stats.completedBooks, 3)} of 3 books`
            };
        case "five-books":
            return {
                current: stats.completedBooks,
                target: 5,
                label: `${Math.min(stats.completedBooks, 5)} of 5 books`
            };
        case "challenging-finish":
            return {
                current: stats.challengingBooksCompleted,
                target: 1,
                label: `${Math.min(stats.challengingBooksCompleted, 1)} of 1 book`
            };
        case "strategy-finish":
            return {
                current: stats.strategyBooksCompleted,
                target: 1,
                label: `${Math.min(stats.strategyBooksCompleted, 1)} of 1 book`
            };
        case "psychology-finish":
            return {
                current: stats.psychologyBooksCompleted,
                target: 1,
                label: `${Math.min(stats.psychologyBooksCompleted, 1)} of 1 book`
            };
        case "category-triad":
            return {
                current: stats.completedCategoriesCount,
                target: 3,
                label: `${Math.min(stats.completedCategoriesCount, 3)} of 3 categories`
            };
        case "mastered-book":
            return {
                current: stats.booksCompletedWithAllQuizzesPassed,
                target: 1,
                label: `${Math.min(stats.booksCompletedWithAllQuizzesPassed, 1)} of 1 book`
            };
        case "context-triad":
            return {
                current: stats.viewedExampleContexts.length,
                target: 3,
                label: `${stats.viewedExampleContexts.length} of 3 contexts`
            };
        case "personal-five":
            return {
                current: stats.personalExamplesChapters,
                target: 5,
                label: `${Math.min(stats.personalExamplesChapters, 5)} of 5 chapters`
            };
        case "school-five":
            return {
                current: stats.schoolExamplesChapters,
                target: 5,
                label: `${Math.min(stats.schoolExamplesChapters, 5)} of 5 chapters`
            };
        case "work-five":
            return {
                current: stats.workExamplesChapters,
                target: 5,
                label: `${Math.min(stats.workExamplesChapters, 5)} of 5 chapters`
            };
        case "examples-ten":
            return {
                current: stats.examplesViewedChapters,
                target: 10,
                label: `${Math.min(stats.examplesViewedChapters, 10)} of 10 chapters`
            };
        case "notes-ten":
            return {
                current: stats.notesCount,
                target: 10,
                label: `${Math.min(stats.notesCount, 10)} of 10 notes`
            };
        case "notes-three-books":
            return {
                current: stats.noteBooksCount,
                target: 3,
                label: `${Math.min(stats.noteBooksCount, 3)} of 3 books`
            };
        case "reflection-finish":
            return {
                current: stats.completedChaptersWithReflection,
                target: 5,
                label: `${Math.min(stats.completedChaptersWithReflection, 5)} of 5 chapters`
            };
        case "category-explorer":
            return {
                current: stats.exploredCategories,
                target: 3,
                label: `${Math.min(stats.exploredCategories, 3)} of 3 categories`
            };
        case "challenging-trial":
            return {
                current: stats.challengingBooksStarted,
                target: 1,
                label: `${Math.min(stats.challengingBooksStarted, 1)} of 1 book`
            };
        case "long-gap-return":
            return {
                current: stats.returnedAfterLongGap,
                target: 1,
                label: `${Math.min(stats.returnedAfterLongGap, 1)} of 1 return`
            };
        case "reading-list-five":
            return {
                current: stats.readingListCount,
                target: 5,
                label: `${Math.min(stats.readingListCount, 5)} of 5 books`
            };
        case "pro-activated":
            return {
                current: stats.proActivated ? 1 : 0,
                target: 1,
                label: `${stats.proActivated ? 1 : 0} of 1 upgrade`
            };
        case "pro-multi-track":
            return {
                current: stats.proMultiTrack ? 3 : 0,
                target: 3,
                label: stats.proMultiTrack ? "3 of 3 active books" : "0 of 3 active books"
            };
        default:
            return {
                current: 0,
...
function evaluateBadges(stats, earnedHistory = {}) {
...
function filterBadges(badges, filter) {
...
"[project]/app/book/data/mockUserLibraryState.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const LIBRARY_CATEGORY_METADATA = {};
function initialChaptersTotal(book) {
    const bundleSize = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$data$2f$mockChapters$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBookChaptersBundle"])(book.id).chapters.length;
    if (bundleSize > 0) return bundleSize;
    return Math.max(1, Math.round(book.estimatedMinutes / 15));
}
function buildLibraryCatalog() {
    return __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$data$2f$booksCatalog$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BOOKS_CATALOG"].map((book)=>({
            ...book,
            status: "not_started",
            progressPercent: 0,
...
function getLibraryBookById(bookId) {
    return buildLibraryCatalog().find((entry)=>entry.id === bookId);
}
function rankLibraryCategories(categories) {
    const fallbackRank = new Map(FALLBACK_LIBRARY_CATEGORY_ORDER.map((category, index)=>[
            category,
            index + 1
        ]));
    const categoryCount = new Map();
    for (const book of __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$data$2f$booksCatalog$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BOOKS_CATALOG"]){
        categoryCount.set(book.category, (categoryCount.get(book.category) ?? 0) + 1);
    }
    return [
        ...categories
    ].sort((left, right)=>{
        const leftRank = LIBRARY_CATEGORY_METADATA[left]?.popularityRank ?? fallbackRank.get(left) ?? Number.MAX_SAFE_INTEGER;
        const rightRank = LIBRARY_CATEGORY_METADATA[right]?.popularityRank ?? fallbackRank.get(right) ?? Number.MAX_SAFE_INTEGER;
...
const derivedCategories = rankLibraryCategories(Array.from(new Set(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$data$2f$booksCatalog$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BOOKS_CATALOG"].map((book)=>book.category))));
const derivedDifficulties = Array.from(new Set(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$data$2f$booksCatalog$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BOOKS_CATALOG"].map((book)=>book.difficulty)));
const LIBRARY_CATEGORY_OPTIONS = [
    "All",
    ...derivedCategories
];
const LIBRARY_CATEGORY_COUNT = derivedCategories.length;
const LIBRARY_DIFFICULTY_OPTIONS = [
    "All",
    ...derivedDifficulties
];
...
"[project]/app/book/hooks/bookStorageEvents.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "BOOK_STORAGE_EVENT",
    ()=>BOOK_STORAGE_EVENT,
    "emitBookStorageChanged",
    ()=>emitBookStorageChanged
]);
"use client";
const BOOK_STORAGE_EVENT = "book-accelerator:storage-changed";
function emitBookStorageChanged(scope) {
...
"[project]/app/book/library/hooks/readingActivityStorage.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"use client";
const READING_ACTIVITY_PREFIX = "book-accelerator:reading-activity:v1";
function getReadingActivityStorageKey(bookId, chapterId) {
    return `${READING_ACTIVITY_PREFIX}:${bookId}:${chapterId}`;
}
function parseReadingActivity(raw) {
    if (!raw) return null;
    try {
        const parsed = JSON.parse(raw);
        return {
            totalActiveMs: Number.isFinite(Number(parsed.totalActiveMs)) && Number(parsed.totalActiveMs) >= 0 ? Math.round(Number(parsed.totalActiveMs)) : 0,
            dailyActiveMs: parsed.dailyActiveMs && typeof parsed.dailyActiveMs === "object" ? Object.fromEntries(Object.entries(parsed.dailyActiveMs).filter(([dayKey, value])=>typeof dayKey === "string" && /^\d{4}-\d{2}-\d{2}$/.test(dayKey) && Number.isFinite(Number(value)) && Number(value) >= 0)) : {},
            updatedAt: typeof parsed.updatedAt === "string" && parsed.updatedAt.trim() ? parsed.updatedAt : new Date(0).toISOString()
        };
    } catch  {
        return null;
    }
}
function emptyReadingActivity() {
    return {
        totalActiveMs: 0,
        dailyActiveMs: {},
...
function appendReadingActivity(current, now, deltaMs) {
...
"[project]/app/book/hooks/useBookAnalytics.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$_lib$2f$book$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/book/_lib/book-api.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$data$2f$mockChapters$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/book/data/mockChapters.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$data$2f$mockUserLibraryState$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/book/data/mockUserLibraryState.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$hooks$2f$bookStorageEvents$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/book/hooks/bookStorageEvents.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$library$2f$hooks$2f$readingActivityStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/book/library/hooks/readingActivityStorage.ts [app-client] (ecmascript)");
var _s = __turbopack_context__.k.signature();
"use client";
;
;
...
function previousDayKey(dayKey) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$library$2f$hooks$2f$readingActivityStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDayKey"])(date);
}
...
function formatRelativeDayLabel(dayKey) {
    if (!dayKey) return EMPTY_ACTIVITY_LABEL;
    const today = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$library$2f$hooks$2f$readingActivityStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDayKey"])(new Date());
    if (dayKey === today) return "Today";
    if (dayKey === previousDayKey(today)) return "Yesterday";
    return formatDayLabel(dayKey);
}
function hasMeaningfulReaderActivity(reader) {
...
function chapterLabelById(bookId, chapterId) {
    if (!chapterId) return "Not started";
    const chapter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$data$2f$mockChapters$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBookChaptersBundle"])(bookId).chapters.find((item)=>item.id === chapterId);
    if (!chapter) return "Not started";
    return `${chapter.code} ${chapter.title}`;
}
function statusFromCounts(completed, total) {
    if (total > 0 && completed >= total) return "completed";
    if (completed > 0) return "in_progress";
    return "not_started";
}
function buildActivities(bookId, chapterCompletedAt) {
    const chapters = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$data$2f$mockChapters$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBookChaptersBundle"])(bookId).chapters;
    const chapterMap = new Map(chapters.map((chapter)=>[
            chapter.id,
            chapter
        ]));
    return Object.entries(chapterCompletedAt).map(([chapterId, completedAt])=>{
        const chapter = chapterMap.get(chapterId);
        if (!chapter) return null;
        const dayKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$library$2f$hooks$2f$readingActivityStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDayKey"])(completedAt);
...
function buildHeatmap(activityByDay) {
    const cells = [];
    ...
    for(let offset = 83; offset >= 0; offset -= 1){
        ...
        const dayKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$library$2f$hooks$2f$readingActivityStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDayKey"])(date);
        const stats = activityByDay.get(dayKey) ?? {
            activeMs: 0,
            chapters: 0
        };
        const minutes = Math.floor(stats.activeMs / 60000);
        const level = minutes <= 0 ? 0 : minutes < 15 ? 1 : minutes < 30 ? 2 : minutes < 50 ? 3 : 4;
        cells.push({
            key: dayKey,
...
function calculateCurrentStreak(activityDays) {
    ...
    let cursor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$library$2f$hooks$2f$readingActivityStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDayKey"])(new Date());
    let streak = 0;
...
function useBookAnalytics(selectedBookIds, dailyGoalMinutes) {
    _s();
    const [hydrated, setHydrated] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const [revision, setRevision] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const seedKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useBookAnalytics.useMemo[seedKey]": ()=>`${selectedBookIds.join("|")}::${dailyGoalMinutes}`
    }["useBookAnalytics.useMemo[seedKey]"], [
        dailyGoalMinutes,
        selectedBookIds
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useBookAnalytics.useEffect": ()=>{
            function onStorageChange() {
                setRevision({
                    "useBookAnalytics.useEffect.onStorageChange": (value)=>value + 1
                }["useBookAnalytics.useEffect.onStorageChange"]);
            }
            window.addEventListener(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$hooks$2f$bookStorageEvents$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BOOK_STORAGE_EVENT"], onStorageChange);
            window.addEventListener("storage", onStorageChange);
            window.addEventListener("focus", onStorageChange);
            return ({
                "useBookAnalytics.useEffect": ()=>{
                    window.removeEventListener(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$hooks$2f$bookStorageEvents$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BOOK_STORAGE_EVENT"], onStorageChange);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useBookAnalytics.useEffect": ()=>{
            let mounted = true;
            const load = {
                "useBookAnalytics.useEffect.load": async ()=>{
                    try {
                        const payload = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$_lib$2f$book$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchBookJson"])("/app/api/book/me/dashboard");
                        if (!mounted) return;
                        const localEntries = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$data$2f$mockUserLibraryState$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildLibraryCatalog"])();
                        const catalogIds = payload.catalog.length > 0 ? new Set(payload.catalog.map({
                            "useBookAnalytics.useEffect.load": (item)=>item.bookId
                        }["useBookAnalytics.useEffect.load"])) : new Set(localEntries.map({
                            "useBookAnalytics.useEffect.load": (item)=>item.id
                        }["useBookAnalytics.useEffect.load"]));
                        const entries = localEntries.filter({
                            "useBookAnalytics.useEffect.load.entries": (entry)=>catalogIds.has(entry.id)
                        }["useBookAnalytics.useEffect.load.entries"]);
                        const progressByBook = new Map(payload.progress.map({
                            "useBookAnalytics.useEffect.load": (item)=>[
                                    item.bookId,
                                    item
                                ]
                        }["useBookAnalytics.useEffect.load"]));
                        const stateByBook = new Map(payload.bookStates.map({
                            "useBookAnalytics.useEffect.load": (item)=>[
                                    item.bookId,
                                    item
                                ]
                        }["useBookAnalytics.useEffect.load"]));
                        const chapterStatesByBook = new Map();
                        payload.chapterStates.forEach({
                            "useBookAnalytics.useEffect.load": (item)=>{
                        ...
                        const allActivities = [];
                        const readingByDay = new Map();
                        payload.readingDays.forEach({
                            "useBookAnalytics.useEffect.load": (item)=>{
                        ...
                        const bookSnapshots = entries.map({
                            "useBookAnalytics.useEffect.load.bookSnapshots": (entry)=>{
                                const chaptersBundle = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$data$2f$mockChapters$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBookChaptersBundle"])(entry.id);
                                ...
                                const completedChapters = new Set(state?.completedChapterIds ?? (progress?.completedChapters ?? []).map({
                                    "useBookAnalytics.useEffect.load.bookSnapshots": (chapterNumber)=>chapters.find({
                                            "useBookAnalytics.useEffect.load.bookSnapshots": (chapter)=>chapter.order === chapterNumber
                                        }["useBookAnalytics.useEffect.load.bookSnapshots"])?.id ?? ""
                                }["useBookAnalytics.useEffect.load.bookSnapshots"]).filter(Boolean)).size;
                                const status = statusFromCounts(completedChapters, totalChapters);
                                const progressPercent = totalChapters ? Math.min(100, Math.round(completedChapters / totalChapters * 100)) : 0;
                                const scoreValues = Object.values(state?.chapterScores ?? Object.fromEntries(Object.entries(progress?.bestScoreByChapter ?? {}).map({
                                    "useBookAnalytics.useEffect.load.bookSnapshots.scoreValues": ([chapterNumber, score])=>{
                                        const chapterId = chapters.find({
                                            "useBookAnalytics.useEffect.load.bookSnapshots.scoreValues": (chapter)=>chapter.order === Number(chapterNumber)
                                        }["useBookAnalytics.useEffect.load.bookSnapshots.scoreValues"])?.id;
                                        return chapterId ? [
                                            chapterId,
                                            score
                                        ] : null;
                                    }
                                }["useBookAnalytics.useEffect.load.bookSnapshots.scoreValues"]).filter({
                                    "useBookAnalytics.useEffect.load.bookSnapshots.scoreValues": (item)=>Boolean(item)
                                }["useBookAnalytics.useEffect.load.bookSnapshots.scoreValues"]))).map({
                                    "useBookAnalytics.useEffect.load.bookSnapshots.scoreValues": (value)=>Number(value)
                                }["useBookAnalytics.useEffect.load.bookSnapshots.scoreValues"]);
                                const bestScore = scoreValues.length ? Math.max(...scoreValues) : 0;
                                const avgScore = scoreValues.length ? Math.round(scoreValues.reduce({
                                    "useBookAnalytics.useEffect.load.bookSnapshots": (sum, value)=>sum + value
                                }["useBookAnalytics.useEffect.load.bookSnapshots"], 0) / scoreValues.length) : 0;
                                const resumeChapterId = state?.currentChapterId || chapters.find({
                                    "useBookAnalytics.useEffect.load.bookSnapshots": (chapter)=>chapter.order === (progress?.currentChapterNumber ?? 1)
                                }["useBookAnalytics.useEffect.load.bookSnapshots"])?.id || chapters[0]?.id || "";
                                const lastActivityAt = state?.lastOpenedAt || progress?.lastActiveAt || progress?.lastOpenedAt || entry.lastActivityAt;
                                return {
                                    book: entry,
                                    status,
                                    completedChapters,
                                    ...
                                    bestScore,
                                    avgScore,
                                    lastOpenedLabel: state?.lastReadChapterId && state.lastOpenedAt !== new Date(0).toISOString() ? chapterLabelById(entry.id, state.lastReadChapterId) : "Not started",
                                    lastActivityAt,
                                    resumeChapterId
                                };
                            }
                        }["useBookAnalytics.useEffect.load.bookSnapshots"]);
                        const engagedBookSnapshots = bookSnapshots.filter({
                            "useBookAnalytics.useEffect.load.engagedBookSnapshots": (snapshot)=>{
                                ...
                                const hasQuizScore = Object.values(state?.chapterScores ?? {}).some({
                                    "useBookAnalytics.useEffect.load.engagedBookSnapshots.hasQuizScore": (score)=>Number(score) > 0
                                }["useBookAnalytics.useEffect.load.engagedBookSnapshots.hasQuizScore"]);
                                const hasReaderActivity = chapterStates.some({
                                    "useBookAnalytics.useEffect.load.engagedBookSnapshots.hasReaderActivity": (item)=>hasMeaningfulReaderActivity(item.state)
                                }["useBookAnalytics.useEffect.load.engagedBookSnapshots.hasReaderActivity"]);
                                return hasCompletedChapter || hasQuizScore || hasReaderActivity;
                            }
                        }["useBookAnalytics.useEffect.load.engagedBookSnapshots"]);
                        for (const activity of allActivities){
                            const current = readingByDay.get(activity.dayKey) ?? {
                                activeMs: 0,
                                chapters: 0
                            };
                        ...
                        const activityDays = Array.from(readingByDay.entries()).filter({
                            "useBookAnalytics.useEffect.load.activityDays": ([, stats])=>stats.activeMs > 0
                        }["useBookAnalytics.useEffect.load.activityDays"]).map({
                            "useBookAnalytics.useEffect.load.activityDays": ([dayKey])=>dayKey
                        }["useBookAnalytics.useEffect.load.activityDays"]).sort();
                        const todayKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$library$2f$hooks$2f$readingActivityStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDayKey"])(new Date());
                        const todayStats = readingByDay.get(todayKey) ?? {
                            activeMs: 0,
                            chapters: 0
                        };
                        const scoreValues = bookSnapshots.map({
                            "useBookAnalytics.useEffect.load.scoreValues": (item)=>item.avgScore
                        }["useBookAnalytics.useEffect.load.scoreValues"]).filter({
                            "useBookAnalytics.useEffect.load.scoreValues": (score)=>score > 0
                        }["useBookAnalytics.useEffect.load.scoreValues"]);
                        const avgQuizScore = scoreValues.length ? Math.round(scoreValues.reduce({
                            "useBookAnalytics.useEffect.load": (sum, score)=>sum + score
                        }["useBookAnalytics.useEffect.load"], 0) / scoreValues.length) : 0;
                        const maxQuizScore = Math.max(0, ...bookSnapshots.map({
                            "useBookAnalytics.useEffect.load.maxQuizScore": (item)=>item.bestScore
                        }["useBookAnalytics.useEffect.load.maxQuizScore"]));
                        const booksCompleted = bookSnapshots.filter({
                            "useBookAnalytics.useEffect.load": (item)=>item.status === "completed"
                        }["useBookAnalytics.useEffect.load"]).length;
                        const totalCompletedChapters = bookSnapshots.reduce({
                            "useBookAnalytics.useEffect.load.totalCompletedChapters": (sum, item)=>sum + item.completedChapters
                        }["useBookAnalytics.useEffect.load.totalCompletedChapters"], 0);
                        ...
                        const completedBookSnapshots = engagedBookSnapshots.filter({
                            "useBookAnalytics.useEffect.load.completedBookSnapshots": (item)=>item.status === "completed"
                        }["useBookAnalytics.useEffect.load.completedBookSnapshots"]);
                        const inProgressBookSnapshots = engagedBookSnapshots.filter({
                            "useBookAnalytics.useEffect.load.inProgressBookSnapshots": (item)=>item.status === "in_progress"
                        }["useBookAnalytics.useEffect.load.inProgressBookSnapshots"]);
                        const upcomingReviews = inProgressBookSnapshots.slice(0, 3).map({
                            "useBookAnalytics.useEffect.load.upcomingReviews": (item, index)=>{
                        ...
                        }["useBookAnalytics.useEffect.load.upcomingReviews"]);
                        setAnalytics({
...
_s(useBookAnalytics, "oAwfzc8vmPbGTgDDfWUww4+ssg8=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/app/book/hooks/useBadgeSystem.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$_lib$2f$book$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/book/_lib/book-api.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$_lib$2f$reader$2d$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/book/_lib/reader-storage.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$data$2f$booksCatalog$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/book/data/booksCatalog.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$data$2f$mockBadges$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/book/data/mockBadges.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$data$2f$mockChapters$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/book/data/mockChapters.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$hooks$2f$useBookAnalytics$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/book/hooks/useBookAnalytics.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$hooks$2f$bookStorageEvents$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/book/hooks/bookStorageEvents.ts [app-client] (ecmascript)");
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function deriveBadgeStats(analytics, dailyGoalMinutes, plan, selectedBookIds) {
    const bookProgressEntries = __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$data$2f$booksCatalog$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BOOKS_CATALOG"].map((book)=>({
            book,
            stored: (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$_lib$2f$reader$2d$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseStoredBookProgress"])(window.localStorage.getItem((0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$_lib$2f$reader$2d$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBookProgressStorageKey"])(book.id)))
        }));
    ...
    const viewedExampleContexts = new Set();
    ...
    const usedReadingModes = new Set();
    for (const { book, stored } of bookProgressEntries){
        if (!stored) continue;
        const completedChapterIds = new Set(stored.completedChapterIds);
        const chapterIds = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$data$2f$mockChapters$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBookChaptersBundle"])(book.id).chapters.map((chapter)=>chapter.id);
        const isStarted = completedChapterIds.size > 0 || Object.keys(stored.chapterScores).length > 0 || Boolean(stored.currentChapterId) || stored.lastOpenedAt !== new Date(0).toISOString();
        ...
        const passedQuizChapters = new Set();
        let allCompletedInDeeperMode = isCompleted;
        let allChapterQuizzesPassed = isCompleted;
        let bookHasPassedQuiz = false;
        for (const chapterId of chapterIds){
            const reader = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$_lib$2f$reader$2d$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseStoredReaderState"])(window.localStorage.getItem((0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$_lib$2f$reader$2d$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getChapterReaderStorageKey"])(book.id, chapterId)));
    ...
    const completedGoalDays = analytics.heatmapCells.filter((cell)=>cell.minutes >= Math.max(dailyGoalMinutes, 1)).length;
    ...
    return {
        ...
        startedBooks: bookProgressEntries.filter(({ stored })=>{
            ...
            return stored.completedChapterIds.length > 0 || Boolean(stored.currentChapterId) || Object.keys(stored.chapterScores).length > 0 || stored.lastOpenedAt !== new Date(0).toISOString();
        }).length,
        ...
        proMultiTrack: plan === "PRO" && analytics.bookSnapshots.filter((snapshot)=>snapshot.status === "in_progress").length >= 3,
        recapCompletions
    };
}
...
function buildNextMilestones(badges) {
    return badges.filter((badge)=>!badge.earned && badge.isVisible).map((badge)=>{
        const progressPercent = badge.targetValue > 0 ? Math.max(0, Math.min(100, Math.round(badge.progressValue / badge.targetValue * 100))) : 0;
...
function useBadgeSystem({ selectedBookIds, dailyGoalMinutes, plan = "FREE" }) {
    _s();
    const { analytics, hydrated } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$hooks$2f$useBookAnalytics$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBookAnalytics"])(selectedBookIds, dailyGoalMinutes);
    const [revision, setRevision] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [earnedHistory, setEarnedHistory] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useBadgeSystem.useEffect": ()=>{
            function onStorageChange() {
                setRevision({
                    "useBadgeSystem.useEffect.onStorageChange": (value)=>value + 1
                }["useBadgeSystem.useEffect.onStorageChange"]);
            }
            window.addEventListener(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$hooks$2f$bookStorageEvents$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BOOK_STORAGE_EVENT"], onStorageChange);
            window.addEventListener("storage", onStorageChange);
            window.addEventListener("focus", onStorageChange);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useBadgeSystem.useEffect": ()=>{
            ...
            let mounted = true;
            const localFallback = ({
                "useBadgeSystem.useEffect.localFallback": ()=>{
                    try {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$_lib$2f$book$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchBookJson"])("/app/api/book/me/badges").then({
                "useBadgeSystem.useEffect": (payload)=>{
                    if (!mounted) return;
                    const next = Object.fromEntries(payload.awards.map({
                        "useBadgeSystem.useEffect.next": (award)=>[
                                award.badgeId,
                                award.earnedAt
                            ]
                    }["useBadgeSystem.useEffect.next"]));
                    window.localStorage.setItem(BADGE_EARNED_KEY, JSON.stringify(next));
                    setEarnedHistory(next);
                }
            }["useBadgeSystem.useEffect"]).catch({
                "useBadgeSystem.useEffect": ()=>{
                    if (!mounted) return;
                    setEarnedHistory(localFallback);
                }
    ...
    const badgeStats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useBadgeSystem.useMemo[badgeStats]": ()=>{
    ...
    const badges = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useBadgeSystem.useMemo[badges]": ()=>{
            if (!badgeStats) return [];
            return sortBadges((0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$data$2f$mockBadges$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["evaluateBadges"])(badgeStats, earnedHistory).map({
                "useBadgeSystem.useMemo[badges]": (badge)=>({
                        ...badge,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useBadgeSystem.useEffect": ()=>{
            if (!badges.length || ("TURBOPACK compile-time value", "object") === "undefined") return;
            const now = Date.now();
            const newEntries = badges.filter({
                "useBadgeSystem.useEffect.newEntries": (badge)=>badge.earned && !earnedHistory[badge.id]
            }["useBadgeSystem.useEffect.newEntries"]);
            if (!newEntries.length) return;
            setEarnedHistory({
                "useBadgeSystem.useEffect": (current)=>{
                    const next = {
                        ...current
                    };
                    newEntries.forEach({
                        "useBadgeSystem.useEffect": (badge, index)=>{
                            next[badge.id] = new Date(now + index * 1000).toISOString();
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$_lib$2f$book$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchBookJson"])("/app/api/book/me/badges", {
                                method: "PUT",
                                body: JSON.stringify({
                                    badgeId: badge.id,
    ...
    const visibleBadges = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useBadgeSystem.useMemo[visibleBadges]": ()=>badges.filter({
                "useBadgeSystem.useMemo[visibleBadges]": (badge)=>badge.isVisible
            }["useBadgeSystem.useMemo[visibleBadges]"])
    }["useBadgeSystem.useMemo[visibleBadges]"], [
        badges
    ]);
    const earnedBadges = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useBadgeSystem.useMemo[earnedBadges]": ()=>visibleBadges.filter({
                "useBadgeSystem.useMemo[earnedBadges]": (badge)=>badge.earned
            }["useBadgeSystem.useMemo[earnedBadges]"]).sort({
                "useBadgeSystem.useMemo[earnedBadges]": (left, right)=>{
            ...
            }["useBadgeSystem.useMemo[earnedBadges]"])
    }["useBadgeSystem.useMemo[earnedBadges]"], [
        visibleBadges
    ]);
    const lockedBadges = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useBadgeSystem.useMemo[lockedBadges]": ()=>visibleBadges.filter({
                "useBadgeSystem.useMemo[lockedBadges]": (badge)=>!badge.earned
            }["useBadgeSystem.useMemo[lockedBadges]"])
    }["useBadgeSystem.useMemo[lockedBadges]"], [
        visibleBadges
    ]);
    const recentlyEarned = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useBadgeSystem.useMemo[recentlyEarned]": ()=>earnedBadges.slice(0, 6)
    }["useBadgeSystem.useMemo[recentlyEarned]"], [
        earnedBadges
    ]);
    const highestPrestigeBadges = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useBadgeSystem.useMemo[highestPrestigeBadges]": ()=>[
                ...earnedBadges
            ].sort({
                "useBadgeSystem.useMemo[highestPrestigeBadges]": (left, right)=>{
                    if (left.prestige !== right.prestige) return right.prestige - left.prestige;
                    return left.name.localeCompare(right.name);
                }
            }["useBadgeSystem.useMemo[highestPrestigeBadges]"]).slice(0, 6)
    }["useBadgeSystem.useMemo[highestPrestigeBadges]"], [
        earnedBadges
    ]);
    const featuredBadges = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useBadgeSystem.useMemo[featuredBadges]": ()=>uniqueBadges([
                ...recentlyEarned.slice(0, 3),
                ...highestPrestigeBadges.slice(0, 3)
            ]).slice(0, 6)
    }["useBadgeSystem.useMemo[featuredBadges]"], [
        highestPrestigeBadges,
        recentlyEarned
    ]);
    const nextMilestones = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useBadgeSystem.useMemo[nextMilestones]": ()=>buildNextMilestones(visibleBadges)
    }["useBadgeSystem.useMemo[nextMilestones]"], [
        visibleBadges
    ]);
    const badgeTimeline = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useBadgeSystem.useMemo[badgeTimeline]": ()=>earnedBadges.filter({
                "useBadgeSystem.useMemo[badgeTimeline]": (badge)=>Boolean(badge.earnedAt)
            }["useBadgeSystem.useMemo[badgeTimeline]"]).slice(0, 10).map({
                "useBadgeSystem.useMemo[badgeTimeline]": (badge)=>({
            ...
            }["useBadgeSystem.useMemo[badgeTimeline]"])
    }["useBadgeSystem.useMemo[badgeTimeline]"], [
        earnedBadges
    ]);
    const categoryGroups = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useBadgeSystem.useMemo[categoryGroups]": ()=>CATEGORY_ORDER.map({
                "useBadgeSystem.useMemo[categoryGroups]": (category)=>({
                        category,
                        title: category,
                        description: CATEGORY_DESCRIPTIONS[category],
                        badges: visibleBadges.filter({
                            "useBadgeSystem.useMemo[categoryGroups]": (badge)=>badge.category === category
                        }["useBadgeSystem.useMemo[categoryGroups]"])
                    })
            }["useBadgeSystem.useMemo[categoryGroups]"]).filter({
                "useBadgeSystem.useMemo[categoryGroups]": (group)=>group.badges.length > 0
            }["useBadgeSystem.useMemo[categoryGroups]"])
    }["useBadgeSystem.useMemo[categoryGroups]"], [
        visibleBadges
    ]);
...
_s(useBadgeSystem, "SBmAwFqMe7d8XfNqocCRktHggbc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$hooks$2f$useBookAnalytics$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBookAnalytics"]
    ];
});
const BADGE_CATEGORY_COPY = CATEGORY_DESCRIPTIONS;
const BADGE_CATEGORY_ORDER = CATEGORY_ORDER;
const BADGE_TIER_SUCCESSION = NEXT_TIER_MAP;
const BADGE_ALL_IDS = __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$data$2f$mockBadges$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BADGE_DEFINITIONS"].map(_c = (badge)=>badge.id);
_c1 = BADGE_ALL_IDS;
var _c, _c1;
__turbopack_context__.k.register(_c, "BADGE_ALL_IDS$BADGE_DEFINITIONS.map");
__turbopack_context__.k.register(_c1, "BADGE_ALL_IDS");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/app/book/hooks/useBookState.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$data$2f$booksCatalog$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/book/data/booksCatalog.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$data$2f$mockProgress$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/book/data/mockProgress.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$hooks$2f$bookStorageEvents$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/book/hooks/bookStorageEvents.ts [app-client] (ecmascript)");
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function createDefaultState(seed) {
    const recentBooks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$data$2f$mockProgress$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildRecentBooks"])(seed.selectedBookIds);
    ...
    return {
        ...
        recentBooks,
        todaySession: (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$data$2f$mockProgress$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildTodaySessionTasks"])(currentChapter)
    };
}
function parseStored(value, seed) {
    if (!value) return null;
    try {
        const parsed = JSON.parse(value);
        const defaults = createDefaultState(seed);
        const recentBooks = Array.isArray(parsed.recentBooks) && parsed.recentBooks.length ? parsed.recentBooks.filter((book)=>typeof book?.bookId === "string" && AVAILABLE_BOOK_IDS.has(book.bookId)) : defaults.recentBooks;
        ...
        const currentBookId = typeof parsed.currentBookId === "string" && parsed.currentBookId.trim() && AVAILABLE_BOOK_IDS.has(parsed.currentBookId) ? parsed.currentBookId : fallbackCurrent;
        return {
            ...defaults,
            ...parsed,
            currentBookId,
            recentBooks: normalizedRecentBooks,
            todaySession: Array.isArray(parsed.todaySession) && parsed.todaySession.length ? parsed.todaySession : defaults.todaySession,
...
function useBookState(seed) {
    _s();
    const stableSeed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useBookState.useMemo[stableSeed]": ()=>({
                selectedBookIds: [
    ...
    const [state, setState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "useBookState.useState": ()=>createDefaultState(stableSeed)
    }["useBookState.useState"]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useBookState.useEffect": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useBookState.useEffect": ()=>{
            if (!hydrated) return;
            window.localStorage.setItem(STORAGE_KEY, JSON.stringify(state));
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$hooks$2f$bookStorageEvents$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["emitBookStorageChanged"])("dashboard");
        }
    }["useBookState.useEffect"], [
        hydrated,
        state
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useBookState.useEffect": ()=>{
            if (!hydrated) return;
            if (!state.recentBooks.some({
                "useBookState.useEffect": (book)=>book.bookId === state.currentBookId
            }["useBookState.useEffect"])) {
                const fallback = state.recentBooks[0]?.bookId || "";
                setState({
                    "useBookState.useEffect": (prev)=>({
                            ...prev,
                            currentBookId: fallback
                        })
                }["useBookState.useEffect"]);
            }
        }
    ...
    const setSearchQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useBookState.useCallback[setSearchQuery]": (searchQuery)=>{
            setState({
                "useBookState.useCallback[setSearchQuery]": (prev)=>({
                        ...prev,
                        searchQuery
                    })
            }["useBookState.useCallback[setSearchQuery]"]);
        }
    }["useBookState.useCallback[setSearchQuery]"], []);
    const setCurrentBookId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useBookState.useCallback[setCurrentBookId]": (currentBookId)=>{
            setState({
                "useBookState.useCallback[setCurrentBookId]": (prev)=>({
                        ...prev,
                        currentBookId
                    })
            }["useBookState.useCallback[setCurrentBookId]"]);
        }
    }["useBookState.useCallback[setCurrentBookId]"], []);
    const toggleSessionTask = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useBookState.useCallback[toggleSessionTask]": (taskId)=>{
            setState({
                "useBookState.useCallback[toggleSessionTask]": (prev)=>({
                        ...prev,
                        todaySession: prev.todaySession.map({
                            "useBookState.useCallback[toggleSessionTask]": (task)=>task.id === taskId ? {
                                    ...task,
                                    complete: !task.complete
                                } : task
                        }["useBookState.useCallback[toggleSessionTask]"])
                    })
            }["useBookState.useCallback[toggleSessionTask]"]);
        }
    }["useBookState.useCallback[toggleSessionTask]"], []);
    const dismissMobileCta = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useBookState.useCallback[dismissMobileCta]": ()=>{
            setState({
                "useBookState.useCallback[dismissMobileCta]": (prev)=>({
                        ...prev,
                        dismissMobileCta: true
                    })
            }["useBookState.useCallback[dismissMobileCta]"]);
        }
    }["useBookState.useCallback[dismissMobileCta]"], []);
...
_s(useBookState, "U7gV08yKMDUwZFOd1ye16nzpWCM=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/app/book/hooks/useKeyboardShortcut.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/book/hooks/useSavedBooks.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useSavedBooks(enabled = true) {
    _s();
    const [hydrated, setHydrated] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const refresh = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useSavedBooks.useCallback[refresh]": async ()=>{
            if (!enabled) {
                setSaved([]);
                setHydrated(true);
                setLoading(false);
            ...
            setLoading(true);
            try {
                const payload = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$_lib$2f$book$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchBookJson"])("/app/api/book/me/saved");
                setSaved(sortSaved(payload.saved ?? []));
                setError(null);
            } catch (fetchError) {
                const message = fetchError instanceof Error ? fetchError.message : "Unable to load saved books.";
                setError(message);
            } finally{
                setHydrated(true);
                setLoading(false);
    ...
    }["useSavedBooks.useCallback[refresh]"], [
        enabled
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useSavedBooks.useEffect": ()=>{
            void refresh();
        }
    }["useSavedBooks.useEffect"], [
        refresh
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useSavedBooks.useEffect": ()=>{
            function onStorageChange(event) {
                const detail = "detail" in event && event.detail && typeof event.detail === "string" ? event.detail : "";
    ...
    const savedSet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useSavedBooks.useMemo[savedSet]": ()=>new Set(saved.map({
                "useSavedBooks.useMemo[savedSet]": (item)=>item.bookId
            }["useSavedBooks.useMemo[savedSet]"]))
    }["useSavedBooks.useMemo[savedSet]"], [
        saved
    ]);
    const toggleSaved = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useSavedBooks.useCallback[toggleSaved]": async (bookId, options)=>{
            const alreadySaved = savedSet.has(bookId);
            const previous = saved;
            const now = new Date().toISOString();
            const optimistic = alreadySaved ? saved.filter({
                "useSavedBooks.useCallback[toggleSaved]": (item)=>item.bookId !== bookId
            }["useSavedBooks.useCallback[toggleSaved]"]) : sortSaved([
                ...saved,
                {
                    bookId,
                    savedAt: now,
            ...
            setSaved(optimistic);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$hooks$2f$bookStorageEvents$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["emitBookStorageChanged"])("saved-books");
            try {
                if (alreadySaved) {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$_lib$2f$book$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchBookJson"])(`/app/api/book/me/saved?bookId=${encodeURIComponent(bookId)}`, {
                        method: "DELETE"
                    });
                } else {
                    const payload = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$_lib$2f$book$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchBookJson"])("/app/api/book/me/saved", {
                    ...
                    setSaved({
                        "useSavedBooks.useCallback[toggleSaved]": (current)=>sortSaved([
                                ...current.filter({
                                    "useSavedBooks.useCallback[toggleSaved]": (item)=>item.bookId !== bookId
                                }["useSavedBooks.useCallback[toggleSaved]"]),
                                payload.saved
                            ])
                    }["useSavedBooks.useCallback[toggleSaved]"]);
                }
                ...
                setSaved(previous);
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$hooks$2f$bookStorageEvents$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["emitBookStorageChanged"])("saved-books");
                const message = toggleError instanceof Error ? toggleError.message : "Unable to update saved books.";
                setError(message);
                return {
                    saved: alreadySaved,
                    error: message
...
_s(useSavedBooks, "jYJfQtUN3XyjI3a0JXPgjMJDuTk=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/app/book/components/ui/cn.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/book/components/ui/Button.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$components$2f$ui$2f$cn$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/book/components/ui/cn.ts [app-client] (ecmascript)");
"use client";
;
;
const variantClass = {
    primary: "border border-sky-300/35 bg-linear-to-r from-sky-500 to-cyan-400 text-white shadow-[0_12px_24px_rgba(14,165,233,0.3)] hover:brightness-105",
    secondary: "border border-white/22 bg-white/6 text-slate-100 hover:bg-white/11",
    ghost: "border border-transparent bg-transparent text-slate-200 hover:bg-white/8",
    danger: "border border-rose-400/40 bg-rose-500/15 text-rose-100 hover:bg-rose-500/24",
    success: "border border-emerald-300/40 bg-emerald-500/18 text-emerald-100 hover:bg-emerald-500/26"
};
const sizeClass = {
...
function Button({ className, variant = "secondary", size = "md", fullWidth, type = "button", ...props }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
        type: type,
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$components$2f$ui$2f$cn$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("inline-flex items-center justify-center gap-2 font-medium transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-300/45 disabled:cursor-not-allowed disabled:opacity-45", variantClass[variant], sizeClass[size], fullWidth && "w-full", className),
        ...props
    }, void 0, false, {
        fileName: "[project]/app/book/components/ui/Button.tsx",
        lineNumber: 43,
        columnNumber: 5
    }, this);
}
...
"[project]/app/book/components/ui/Card.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
const variantClass = {
    default: "border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.08),rgba(255,255,255,0.03))]",
    accent: "border-sky-300/25 bg-[linear-gradient(145deg,rgba(14,116,144,0.22),rgba(15,23,42,0.8))]",
    interactive: "border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.08),rgba(255,255,255,0.03))] transition hover:-translate-y-0.5 hover:border-sky-300/30 hover:shadow-[0_16px_34px_rgba(2,6,23,0.48)]",
    danger: "border-rose-400/30 bg-rose-500/8"
};
function Card({ variant = "default", className, children, ...props }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$components$2f$ui$2f$cn$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("rounded-3xl border p-5 shadow-[0_16px_40px_rgba(2,6,23,0.45)]", variantClass[variant], className),
        ...props,
        children: children
    }, void 0, false, {
        fileName: "[project]/app/book/components/ui/Card.tsx",
        lineNumber: 26,
        columnNumber: 5
    }, this);
}
...
"[project]/app/book/components/ui/Chip.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Chip({ tone = "neutral", className, ...props }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$components$2f$ui$2f$cn$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("inline-flex items-center rounded-full border px-2.5 py-1 text-xs font-medium", toneClass[tone], className),
        ...props
    }, void 0, false, {
        fileName: "[project]/app/book/components/ui/Chip.tsx",
        lineNumber: 24,
        columnNumber: 5
    }, this);
}
_c = Chip;
function ChipButton({ tone = "neutral", active, className, ...props }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$components$2f$ui$2f$cn$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("inline-flex items-center rounded-full border px-3 py-1.5 text-sm transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-300/45", toneClass[tone], active && "shadow-[0_0_0_1px_rgba(56,189,248,0.25)]", !active && "opacity-85 hover:opacity-100", className),
        ...props
    }, void 0, false, {
        fileName: "[project]/app/book/components/ui/Chip.tsx",
        lineNumber: 42,
...
"[project]/app/book/badges/components/BadgeSystemCards.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$components$2f$ui$2f$Button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/book/components/ui/Button.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$components$2f$ui$2f$Card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/book/components/ui/Card.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$components$2f$ui$2f$Chip$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/book/components/ui/Chip.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$components$2f$ui$2f$cn$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/book/components/ui/cn.ts [app-client] (ecmascript)");
"use client";
;
;
...
function BadgeFilterBar({ filters, activeFilter, onChange }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "flex flex-wrap gap-2",
        children: filters.map((filter)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$components$2f$ui$2f$Chip$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ChipButton"], {
                tone: activeFilter === filter ? "sky" : "neutral",
                active: activeFilter === filter,
                onClick: ()=>onChange(filter),
                children: filter
            }, filter, false, {
                fileName: "[project]/app/book/badges/components/BadgeSystemCards.tsx",
                lineNumber: 51,
                columnNumber: 9
            }, this))
    }, void 0, false, {
...
_c = BadgeFilterBar;
function FeaturedBadgeCard({ badge, subtitle, onOpen }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
        type: "button",
        onClick: onOpen,
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$components$2f$ui$2f$cn$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("group relative overflow-hidden rounded-[28px] border bg-[linear-gradient(150deg,rgba(9,14,28,0.96),rgba(14,20,37,0.88))] p-5 text-left transition", "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-300/45", "hover:-translate-y-0.5 hover:shadow-[0_24px_44px_rgba(2,6,23,0.42)]", accentClass[badge.accent]),
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(255,255,255,0.08),transparent_52%)]"
            }, void 0, false, {
                fileName: "[project]/app/book/badges/components/BadgeSystemCards.tsx",
                lineNumber: 84,
                columnNumber: 7
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "pointer-events-none absolute -right-10 top-0 h-32 w-32 rounded-full bg-white/[0.04] blur-3xl"
            }, void 0, false, {
                fileName: "[project]/app/book/badges/components/BadgeSystemCards.tsx",
                lineNumber: 85,
                columnNumber: 7
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "inline-flex h-14 w-14 items-center justify-center rounded-2xl border border-white/12 bg-white/8 text-3xl shadow-[0_12px_24px_rgba(2,6,23,0.32)]",
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$components$2f$ui$2f$cn$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])(!badge.earned && "opacity-45 grayscale"),
                                    children: badge.icon
                                }, void 0, false, {
                                    fileName: "[project]/app/book/badges/components/BadgeSystemCards.tsx",
                                    lineNumber: 89,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "mt-4 text-[11px] uppercase tracking-[0.22em] text-slate-400",
                                children: subtitle
                            }, void 0, false, {
                                fileName: "[project]/app/book/badges/components/BadgeSystemCards.tsx",
                                lineNumber: 91,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                className: "mt-2 text-xl font-semibold tracking-tight text-slate-50",
                                children: badge.name
                            }, void 0, false, {
                                fileName: "[project]/app/book/badges/components/BadgeSystemCards.tsx",
                                lineNumber: 92,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$components$2f$ui$2f$Chip$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Chip"], {
                        tone: badge.earned ? "amber" : "neutral",
                        className: "shrink-0",
                        children: badge.earned ? "Earned" : badge.tier ?? badge.category
                    }, void 0, false, {
                        fileName: "[project]/app/book/badges/components/BadgeSystemCards.tsx",
                        lineNumber: 95,
                        columnNumber: 9
...
_c1 = FeaturedBadgeCard;
function BadgeCard({ badge, compact = false, onOpen }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
        type: "button",
        onClick: onOpen,
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$components$2f$ui$2f$cn$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("group relative overflow-hidden rounded-[24px] border p-4 text-left transition", "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-300/45", badge.earned ? "border-white/12 bg-[linear-gradient(145deg,rgba(251,191,36,0.12),rgba(255,255,255,0.03))] hover:-translate-y-0.5 hover:shadow-[0_18px_34px_rgba(251,191,36,0.16)]" : "border-white/10 bg-white/[0.03] hover:border-white/18 hover:bg-white/[0.05]"),
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "flex items-start justify-between gap-3",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$components$2f$ui$2f$cn$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("text-3xl transition", !badge.earned && "opacity-40 grayscale"),
                        children: badge.icon
                    }, void 0, false, {
                        fileName: "[project]/app/book/badges/components/BadgeSystemCards.tsx",
                        lineNumber: 125,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$components$2f$ui$2f$cn$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("mt-4 font-semibold tracking-tight", compact ? "text-sm" : "text-base", badge.earned ? "text-slate-50" : "text-slate-200"),
                children: badge.name
            }, void 0, false, {
                fileName: "[project]/app/book/badges/components/BadgeSystemCards.tsx",
                lineNumber: 133,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$components$2f$ui$2f$cn$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("mt-2 text-sm leading-6", compact ? "line-clamp-2" : "", badge.earned ? "text-slate-300" : "text-slate-400"),
                children: badge.description
            }, void 0, false, {
                fileName: "[project]/app/book/badges/components/BadgeSystemCards.tsx",
                lineNumber: 136,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$components$2f$ui$2f$cn$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("font-medium", badge.earned ? "text-amber-200" : "text-slate-500"),
                        children: badge.earned ? "Earned" : badge.progressLabel
                    }, void 0, false, {
                        fileName: "[project]/app/book/badges/components/BadgeSystemCards.tsx",
                        lineNumber: 141,
                        columnNumber: 9
...
_c2 = BadgeCard;
function BadgeCategorySection({ title, description, badges, onOpen }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$components$2f$ui$2f$Card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
        className: "border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.06),rgba(255,255,255,0.03))]",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: badges.map((badge)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(BadgeCard, {
                        badge: badge,
                        onOpen: ()=>onOpen(badge)
                    }, badge.id, false, {
                        fileName: "[project]/app/book/badges/components/BadgeSystemCards.tsx",
...
_c3 = BadgeCategorySection;
function ProgressToNextBadgeCard({ milestone, secondary, onOpen }) {
    if (!milestone) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$components$2f$ui$2f$Card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                    className: "mt-2 text-xl font-semibold tracking-tight text-slate-50",
                    children: "Current visible track is complete"
                }, void 0, false, {
                    fileName: "[project]/app/book/badges/components/BadgeSystemCards.tsx",
                    lineNumber: 202,
                    columnNumber: 9
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    className: "mt-2 text-sm leading-6 text-slate-300",
                    children: "You have cleared the current visible badge queue. More milestones can appear as your reading profile expands."
                }, void 0, false, {
                    fileName: "[project]/app/book/badges/components/BadgeSystemCards.tsx",
                    lineNumber: 203,
                    columnNumber: 9
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$components$2f$ui$2f$Card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
        className: "overflow-hidden border-amber-300/20 bg-[linear-gradient(145deg,rgba(251,191,36,0.12),rgba(9,14,28,0.96))]",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-[11px] uppercase tracking-[0.22em] text-amber-200/70",
                                children: "Next milestone"
                            }, void 0, false, {
                                fileName: "[project]/app/book/badges/components/BadgeSystemCards.tsx",
                                lineNumber: 214,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: milestone.badge.description
                            }, void 0, false, {
                                fileName: "[project]/app/book/badges/components/BadgeSystemCards.tsx",
                                lineNumber: 216,
                                columnNumber: 11
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "inline-flex h-14 w-14 items-center justify-center rounded-2xl border border-white/12 bg-white/8 text-3xl",
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            className: "opacity-85",
                            children: milestone.badge.icon
                        }, void 0, false, {
                            fileName: "[project]/app/book/badges/components/BadgeSystemCards.tsx",
                            lineNumber: 219,
                            columnNumber: 11
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "mt-5 rounded-2xl border border-white/10 bg-black/16 p-4",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "flex items-center justify-between gap-3 text-sm text-slate-200",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                children: milestone.badge.progressLabel
                            }, void 0, false, {
                                fileName: "[project]/app/book/badges/components/BadgeSystemCards.tsx",
                                lineNumber: 224,
                                columnNumber: 11
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            style: {
                                width: `${Math.max(6, milestone.progressPercent)}%`
                            }
                        }, void 0, false, {
                            fileName: "[project]/app/book/badges/components/BadgeSystemCards.tsx",
                            lineNumber: 228,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                children: milestone.nextStepLabel
                            }, void 0, false, {
                                fileName: "[project]/app/book/badges/components/BadgeSystemCards.tsx",
                                lineNumber: 234,
                                columnNumber: 11
                            }, this),
                            milestone.nextTier ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                children: [
                                    "Then ",
                                    milestone.nextTier.name
                                ]
                            }, void 0, true, {
                                fileName: "[project]/app/book/badges/components/BadgeSystemCards.tsx",
                                lineNumber: 235,
            ...
            onOpen ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "mt-5",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$components$2f$ui$2f$Button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                    variant: "secondary",
                    onClick: onOpen,
                    children: "Open badge details"
                }, void 0, false, {
                    fileName: "[project]/app/book/badges/components/BadgeSystemCards.tsx",
                    lineNumber: 241,
                    columnNumber: 11
...
_c4 = ProgressToNextBadgeCard;
function BadgeTimelineItem({ entry, onOpen }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "flex gap-4 rounded-[22px] border border-white/8 bg-black/12 px-4 py-3.5",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "flex flex-col items-center",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                        className: "inline-flex h-12 w-12 items-center justify-center rounded-2xl border border-white/10 bg-white/8 text-2xl",
                        children: entry.icon
                    }, void 0, false, {
                        fileName: "[project]/app/book/badges/components/BadgeSystemCards.tsx",
                        lineNumber: 254,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                        className: "mt-2 h-full w-px bg-white/8"
                    }, void 0, false, {
                        fileName: "[project]/app/book/badges/components/BadgeSystemCards.tsx",
                        lineNumber: 257,
                        columnNumber: 9
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$components$2f$ui$2f$Chip$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Chip"], {
                                tone: entry.notificationStyle === "celebration" ? "amber" : entry.notificationStyle === "toast" ? "sky" : "neutral",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            onOpen ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                type: "button",
                                onClick: onOpen,
                                className: "inline-flex items-center gap-1 text-sm text-sky-200 transition hover:text-sky-100",
                                children: [
                                    "Open",
...
_c5 = BadgeTimelineItem;
function BadgeDetailPanel({ badge, nextTier }) {
    const progressPercent = badge.targetValue > 0 ? Math.max(0, Math.min(100, Math.round(badge.progressValue / badge.targetValue * 100))) : 0;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "space-y-4",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "inline-flex h-16 w-16 items-center justify-center rounded-[22px] border border-white/12 bg-white/8 text-4xl",
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$components$2f$ui$2f$cn$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])(!badge.earned && "opacity-45 grayscale"),
                            children: badge.icon
                        }, void 0, false, {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$components$2f$ui$2f$Chip$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Chip"], {
                                tone: badge.earned ? "amber" : "neutral",
                                children: badge.earned ? "Earned" : "Locked"
                            }, void 0, false, {
                                fileName: "[project]/app/book/badges/components/BadgeSystemCards.tsx",
                                lineNumber: 302,
                                columnNumber: 11
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "rounded-2xl border border-white/10 bg-black/14 p-4",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "flex items-center justify-between gap-3 text-sm text-slate-200",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                children: badge.progressLabel
                            }, void 0, false, {
                                fileName: "[project]/app/book/badges/components/BadgeSystemCards.tsx",
                                lineNumber: 326,
                                columnNumber: 11
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "mt-3 flex flex-wrap items-center justify-between gap-3 text-sm text-slate-400",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                children: badge.earned ? badge.earnedAt ? `Earned on ${new Date(badge.earnedAt).toLocaleDateString()}` : "Earned" : `${Math.max(badge.targetValue - badge.progressValue, 0)} remaining`
                            }, void 0, false, {
                                fileName: "[project]/app/book/badges/components/BadgeSystemCards.tsx",
                                lineNumber: 336,
                                columnNumber: 11
...
_c6 = BadgeDetailPanel;
function DashboardAchievementWidget({ recentBadge, nextMilestone, earnedCount, visibleCount, onOpenBadge, onViewAll }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$components$2f$ui$2f$Card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
        className: "overflow-hidden border-white/10 bg-[linear-gradient(145deg,rgba(9,14,28,0.96),rgba(14,20,37,0.88))]",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                className: "mt-2 text-2xl font-semibold tracking-tight text-slate-50",
                                children: "Quiet momentum, visible progress"
                            }, void 0, false, {
                                fileName: "[project]/app/book/badges/components/BadgeSystemCards.tsx",
                                lineNumber: 370,
                                columnNumber: 11
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: "Badges stay subtle, but the next milestone is always visible so progress feels tangible."
                            }, void 0, false, {
                                fileName: "[project]/app/book/badges/components/BadgeSystemCards.tsx",
                                lineNumber: 371,
                                columnNumber: 11
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            recentBadge ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                type: "button",
                                onClick: ()=>onOpenBadge(recentBadge),
                                className: "mt-4 block w-full rounded-[20px] border border-amber-300/18 bg-amber-500/8 p-4 text-left transition hover:border-amber-300/28",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "flex items-start justify-between gap-3",
                                        children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "mt-3 text-base font-semibold text-slate-50",
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "mt-2 text-sm leading-6 text-slate-300",
                                        children: recentBadge.description
                                    }, void 0, false, {
                                        fileName: "[project]/app/book/badges/components/BadgeSystemCards.tsx",
                                        lineNumber: 392,
                                        columnNumber: 15
                                ...
                                children: "Earned badges will surface here as your reading history grows."
                            }, void 0, false, {
                                fileName: "[project]/app/book/badges/components/BadgeSystemCards.tsx",
                                lineNumber: 395,
                                columnNumber: 13
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            nextMilestone ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                type: "button",
                                onClick: ()=>onOpenBadge(nextMilestone.badge),
                                className: "mt-4 block w-full rounded-[20px] border border-sky-300/18 bg-sky-500/8 p-4 text-left transition hover:border-sky-300/28",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "flex items-start justify-between gap-3",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        ...
                                                        children: nextMilestone.badge.name
                                                    }, void 0, false, {
                                                        fileName: "[project]/app/book/badges/components/BadgeSystemCards.tsx",
                                                        lineNumber: 409,
                                                        columnNumber: 19
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        className: "mt-2 text-sm leading-6 text-slate-300",
                                                        children: nextMilestone.badge.description
                                                    }, void 0, false, {
                                                        fileName: "[project]/app/book/badges/components/BadgeSystemCards.tsx",
                                                        lineNumber: 410,
                                                        columnNumber: 19
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                ...
                                                children: nextMilestone.badge.icon
                                            }, void 0, false, {
                                                fileName: "[project]/app/book/badges/components/BadgeSystemCards.tsx",
                                                lineNumber: 412,
                                                columnNumber: 17
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "h-full rounded-full bg-linear-to-r from-sky-400 to-cyan-300",
                                            style: {
                                                width: `${Math.max(6, nextMilestone.progressPercent)}%`
                                            }
                                        }, void 0, false, {
                                            fileName: "[project]/app/book/badges/components/BadgeSystemCards.tsx",
                                            lineNumber: 415,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "mt-3 flex items-center justify-between gap-3 text-sm text-slate-300",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                children: nextMilestone.badge.progressLabel
                                            }, void 0, false, {
                                                fileName: "[project]/app/book/badges/components/BadgeSystemCards.tsx",
                                                lineNumber: 418,
                                                columnNumber: 17
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                children: nextMilestone.nextStepLabel
                                            }, void 0, false, {
                                                fileName: "[project]/app/book/badges/components/BadgeSystemCards.tsx",
                                                lineNumber: 419,
                                                columnNumber: 17
                                ...
                                className: "mt-4 text-sm leading-6 text-slate-400",
                                children: "The current visible milestone track is complete. Additional long term badges can surface here later."
                            }, void 0, false, {
                                fileName: "[project]/app/book/badges/components/BadgeSystemCards.tsx",
                                lineNumber: 423,
                                columnNumber: 13
...
_c7 = DashboardAchievementWidget;
var _c, _c1, _c2, _c3, _c4, _c5, _c6, _c7;
__turbopack_context__.k.register(_c, "BadgeFilterBar");
__turbopack_context__.k.register(_c1, "FeaturedBadgeCard");
__turbopack_context__.k.register(_c2, "BadgeCard");
__turbopack_context__.k.register(_c3, "BadgeCategorySection");
__turbopack_context__.k.register(_c4, "ProgressToNextBadgeCard");
__turbopack_context__.k.register(_c5, "BadgeTimelineItem");
__turbopack_context__.k.register(_c6, "BadgeDetailPanel");
__turbopack_context__.k.register(_c7, "DashboardAchievementWidget");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/app/book/home/components/SearchBox.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const SearchBox = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["forwardRef"])(_c = function SearchBox({ value, onChange, placeholder = "Search books... (press / to focus)", onFocus }, ref) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$search$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Search$3e$__["Search"], {
                ...
                fileName: "[project]/app/book/home/components/SearchBox.tsx",
                lineNumber: 25,
                columnNumber: 9
            }, this),
...
_c1 = SearchBox;
var _c, _c1;
__turbopack_context__.k.register(_c, "SearchBox$forwardRef");
__turbopack_context__.k.register(_c1, "SearchBox");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/app/book/home/components/GlobalSearchPanel.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function GlobalSearchPanel({ open, query, onClose }) {
    _s();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const search = query.trim().toLowerCase();
    const { books, chapters } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "GlobalSearchPanel.useMemo": ()=>{
            if (!search) {
                return {
                    books: [],
                    chapters: []
            ...
            const bookResults = __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$data$2f$booksCatalog$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BOOKS_CATALOG"].filter({
                "GlobalSearchPanel.useMemo.bookResults": (book)=>{
                    const searchable = `${book.title} ${book.author} ${book.category}`.toLowerCase();
                    return searchable.includes(search);
                }
            }["GlobalSearchPanel.useMemo.bookResults"]).slice(0, 6).map({
                "GlobalSearchPanel.useMemo.bookResults": (book)=>({
                        id: book.id,
                        title: book.title,
                        author: book.author
                    })
            }["GlobalSearchPanel.useMemo.bookResults"]);
            const chapterResults = [];
            for (const book of __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$data$2f$booksCatalog$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BOOKS_CATALOG"]){
                const chaptersBundle = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$data$2f$mockChapters$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBookChaptersBundle"])(book.id);
    ...
    if (!open) return null;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "absolute inset-x-0 top-12 z-40",
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "rounded-2xl border border-white/14 bg-[#0a1224]/96 p-3 shadow-[0_24px_60px_rgba(2,6,23,0.6)] backdrop-blur-xl",
            children: !search ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                ...
                children: "Type to search books and chapters."
            }, void 0, false, {
                fileName: "[project]/app/book/home/components/GlobalSearchPanel.tsx",
                lineNumber: 80,
                columnNumber: 11
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "px-2 py-1 text-xs font-semibold uppercase tracking-[0.14em] text-slate-400",
                                children: "Books"
                            }, void 0, false, {
                                fileName: "[project]/app/book/home/components/GlobalSearchPanel.tsx",
                                lineNumber: 86,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "space-y-1",
                                children: books.length ? books.map((book)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        type: "button",
                                        onClick: ()=>{
                                            onClose();
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "space-y-1",
                                children: chapters.length ? chapters.map((chapter)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        type: "button",
                                        onClick: ()=>{
                                            onClose();
                                            router.push(`/book/library/${encodeURIComponent(chapter.bookId)}/chapter/${encodeURIComponent(chapter.chapterId)}`);
                                        },
                                        className: "flex w-full items-center gap-2 rounded-lg px-2 py-2 text-left text-sm text-slate-200 transition hover:bg-white/8",
                                        children: [
...
_s(GlobalSearchPanel, "qtjvgfDH9KbFf01+vfTpYaS+5TM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c = GlobalSearchPanel;
var _c;
__turbopack_context__.k.register(_c, "GlobalSearchPanel");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
"[project]/app/book/home/components/TopNav.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$home$2f$components$2f$SearchBox$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/book/home/components/SearchBox.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$home$2f$components$2f$GlobalSearchPanel$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/book/home/components/GlobalSearchPanel.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$hooks$2f$useKeyboardShortcut$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/book/hooks/useKeyboardShortcut.ts [app-client] (ecmascript)");
...
function TopNav({ name, activeTab, searchQuery, onSearchChange, searchInputRef, showSearch = true, searchPlaceholder, showGlobalSearchPanel = true }) {
    _s();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$hooks$2f$useKeyboardShortcut$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useKeyboardShortcut"])("/", {
        "TopNav.useKeyboardShortcut": (event)=>{
            if (!showSearch) return;
            event.preventDefault();
            focusSearchInput();
            setShowSearchPanel(true);
        }
    }["TopNav.useKeyboardShortcut"], {
        ignoreWhenTyping: true
    });
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$hooks$2f$useKeyboardShortcut$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useKeyboardShortcut"])("Escape", {
        "TopNav.useKeyboardShortcut": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TopNav.useEffect": ()=>{
            ...
            return ({
                "TopNav.useEffect": ()=>window.removeEventListener("mousedown", onPointerDown)
            })["TopNav.useEffect"];
        }
    }["TopNav.useEffect"], []);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("header", {
                className: "sticky top-0 z-30 border-b border-white/[0.07] bg-[#060a15]/90 backdrop-blur-xl",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ref: headerRef,
                    className: "mx-auto w-full max-w-7xl px-4 py-2.5 sm:px-6",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$components$2f$ChapterFlowMark$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ChapterFlowMark"], {
                                        ...
                                        fileName: "[project]/app/book/home/components/TopNav.tsx",
                                        lineNumber: 122,
                                        columnNumber: 15
                                    }, this)
                                }, void 0, false, {
                                    ...
                                    children: navItems.map((item)=>{
                                        ...
                                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                            ...
                                            className: [
                                                ...
                                                active ? "bg-sky-500/16 text-sky-100" : "text-slate-400 hover:bg-white/6 hover:text-slate-200"
                                            ].join(" "),
                                            "aria-current": active ? "page" : undefined,
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Icon, {
                                                    className: active ? "h-3.5 w-3.5 text-sky-300" : "h-3.5 w-3.5"
                                                }, void 0, false, {
                                                    fileName: "[project]/app/book/home/components/TopNav.tsx",
                                                    lineNumber: 142,
                                                    columnNumber: 21
                                                ...
                                                active && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: "absolute bottom-0 left-1/2 h-0.5 w-5 -translate-x-1/2 rounded-full bg-sky-400"
                                                }, void 0, false, {
                                                    fileName: "[project]/app/book/home/components/TopNav.tsx",
                                                    lineNumber: 145,
                                                    columnNumber: 23
                                ...
                                showSearch ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "relative hidden flex-1 justify-center px-4 md:flex",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$home$2f$components$2f$SearchBox$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SearchBox"], {
                                        ...
                                        showGlobalSearchPanel ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$home$2f$components$2f$GlobalSearchPanel$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GlobalSearchPanel"], {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                            ...
                                            className: [
                                                ...
                                                activeTab === "settings" ? "border-sky-300/35 bg-sky-500/16 text-sky-100" : "border-white/12 bg-white/4 text-slate-400 hover:text-slate-200"
                                            ].join(" "),
                                            "aria-label": "Settings",
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                            ...
                                            className: [
                                                ...
                                                activeTab === "profile" ? "border-sky-300/35 bg-sky-500/16 text-sky-100" : "border-white/12 bg-white/4 text-slate-200"
                                            ].join(" "),
                                            "aria-label": "Profile",
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: "inline-flex h-6 w-6 items-center justify-center rounded-full bg-linear-to-br from-sky-400 to-cyan-300 text-xs font-bold text-slate-900 shadow-[0_0_10px_rgba(56,189,248,0.35)]",
                                                    children: initial
                                                }, void 0, false, {
                                                    fileName: "[project]/app/book/home/components/TopNav.tsx",
                                                    lineNumber: 202,
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            ...
                                            className: [
                                                ...
                                                activeTab === "profile" ? "border-sky-300/35 bg-sky-500/16 text-sky-100" : "border-white/12 bg-white/4 text-slate-400 hover:text-slate-200"
                                            ].join(" "),
                                        ...
                                        showProfileMenu ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "absolute right-0 top-11 w-56 rounded-2xl border border-white/12 bg-[#0b1020]/98 p-2 shadow-[0_24px_50px_rgba(2,6,23,0.65)] backdrop-blur-md",
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "border-b border-white/8 px-3 py-2.5",
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                            className: "text-sm font-semibold text-slate-100",
                                                            children: name || "Reader"
                        ...
                        showSearch ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "relative mt-2.5 md:hidden",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$home$2f$components$2f$SearchBox$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SearchBox"], {
                                    ref: mobileSearchRef,
                                    value: searchQuery,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
                className: "fixed bottom-0 left-0 right-0 z-40 border-t border-white/[0.07] bg-[#060a15]/95 pb-safe backdrop-blur-xl md:hidden",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(TopNav, "6V327aGt9IYoIXlFZj7smNcR2OU=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"],
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$hooks$2f$useKeyboardShortcut$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useKeyboardShortcut"],
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$hooks$2f$useKeyboardShortcut$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useKeyboardShortcut"]
    ];
});
_c = TopNav;
...
"[project]/app/book/home/components/CurrentlyReadingCard.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function estimateMinutesRemaining(book, progress, dailyGoalMinutes) {
...
function CurrentlyReadingCard({ book, progress, dailyGoalMinutes, onContinue }) {
    const remainingMinutes = estimateMinutesRemaining(book, progress, dailyGoalMinutes);
    const chaptersLeft = progress.status === "not_started" ? progress.totalChapters : Math.max(progress.totalChapters - progress.chapter, 0);
    const ctaLabel = progress.status === "not_started" ? `Start Chapter ${progress.chapter}` : `Continue Chapter ${progress.chapter}`;
    const sectionLabel = progress.status === "not_started" ? "Ready to Start" : "Currently Reading";
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("article", {
        className: "group relative overflow-hidden rounded-[30px] border border-sky-300/25 bg-[linear-gradient(135deg,rgba(14,116,144,0.32),rgba(15,23,42,0.88))] p-5 shadow-[0_20px_60px_rgba(2,132,199,0.28)] sm:p-7",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                "aria-hidden": "true",
                ...
                fileName: "[project]/app/book/home/components/CurrentlyReadingCard.tsx",
                lineNumber: 47,
                columnNumber: 7
            }, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: "inline-flex items-center gap-1.5 rounded-full border border-sky-300/40 bg-sky-300/14 px-2.5 py-0.5 text-xs font-semibold uppercase tracking-[0.14em] text-sky-100",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$book$2d$open$2d$text$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__BookOpenText$3e$__["BookOpenText"], {
                                        className: "h-3 w-3"
                                    }, void 0, false, {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                className: "mt-2.5 text-2xl font-semibold tracking-tight text-white sm:text-3xl",
                                children: book.title
                            }, void 0, false, {
                                fileName: "[project]/app/book/home/components/CurrentlyReadingCard.tsx",
                                lineNumber: 77,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "mt-0.5 text-sm text-sky-200/80",
                                children: [
                                    "by ",
                                    book.author
                                ]
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "mt-1.5 h-2 w-full overflow-hidden rounded-full bg-slate-900/50",
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            style: {
                                                width: `${Math.max(progress.progressPercent, 0)}%`
                                            }
                                        }, void 0, false, {
                                            fileName: "[project]/app/book/home/components/CurrentlyReadingCard.tsx",
                                            lineNumber: 89,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "mt-3 flex flex-wrap items-center gap-2 text-xs text-slate-300",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: "inline-flex items-center gap-1 rounded-lg border border-white/12 bg-white/5 px-2.5 py-1",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$clock$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Clock$3e$__["Clock"], {
...
_c = CurrentlyReadingCard;
var _c;
__turbopack_context__.k.register(_c, "CurrentlyReadingCard");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/app/book/home/components/TodaySessionCard.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function TodaySessionCard({ tasks, onToggleTask, onStartSession }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("article", {
        className: "flex flex-col rounded-[30px] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.08),rgba(255,255,255,0.03))] p-5 shadow-[0_16px_42px_rgba(2,6,23,0.48)] sm:p-6",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                ...
                                children: "Today's Session"
                            }, void 0, false, {
                                fileName: "[project]/app/book/home/components/TodaySessionCard.tsx",
                                lineNumber: 25,
                                columnNumber: 11
                            }, this),
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                        className: "inline-flex items-center gap-1 rounded-full border border-amber-300/30 bg-amber-400/10 px-2.5 py-1 text-xs font-semibold text-amber-200",
                        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "mt-3 h-1 w-full overflow-hidden rounded-full bg-slate-800/60",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: tasks.map((task)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            ...
                            className: [
                                ...
                                task.complete ? "border-emerald-300/20 bg-emerald-500/8 opacity-70" : "border-white/8 bg-white/3 hover:border-white/15 hover:bg-white/6"
                            ].join(" "),
                            children: [
                                task.complete ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$circle$2d$check$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__CheckCircle2$3e$__["CheckCircle2"], {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                ...
                className: [
                    ...
                    allDone ? "border border-emerald-300/35 bg-emerald-500/16 text-emerald-100 focus-visible:ring-emerald-300/50" : "bg-linear-to-r from-amber-400 to-yellow-300 text-slate-900 shadow-[0_12px_24px_rgba(250,204,21,0.32)] hover:brightness-105 focus-visible:ring-amber-300/60"
                ].join(" "),
                children: [
...
_c = TodaySessionCard;
var _c;
__turbopack_context__.k.register(_c, "TodaySessionCard");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
"[project]/app/book/home/components/GoalMeter.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function GoalMeter({ goalMinutes, minutesReadToday }) {
    ...
    const ringColor = isComplete ? "rgb(52 211 153)" : safeProgress >= 60 ? "rgb(56 189 248)" : "rgb(56 189 248)";
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("article", {
        className: "flex flex-col rounded-3xl border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.08),rgba(255,255,255,0.03))] p-5",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "flex items-center gap-2",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$target$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Target$3e$__["Target"], {
                        ...
                        fileName: "[project]/app/book/home/components/GoalMeter.tsx",
                        lineNumber: 29,
                        columnNumber: 9
                    }, this),
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                        className: "text-sm font-semibold uppercase tracking-[0.12em] text-slate-300",
                        children: "Daily Goal"
                    }, void 0, false, {
                        fileName: "[project]/app/book/home/components/GoalMeter.tsx",
                        lineNumber: 30,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "mt-4 flex flex-1 items-center gap-4",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "absolute inset-1.5 flex flex-col items-center justify-center rounded-full bg-[#0b1120]",
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: "text-[13px] font-bold leading-none text-slate-100",
                                children: [
                                    safeProgress,
                                    "%"
                                ]
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: [
                                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$components$2f$GoalPicker$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatMinutesLabel"])(minutesReadToday),
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: "ml-1 text-sm font-normal text-slate-400",
                                        children: [
                                            "/ ",
                                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$components$2f$GoalPicker$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatMinutesLabel"])(goalMinutes)
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/app/book/home/components/GoalMeter.tsx",
                                        lineNumber: 55,
                            ...
                            isComplete ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "mt-1 text-xs font-medium text-emerald-300",
                                children: "Goal reached today ✓"
                            }, void 0, false, {
                                fileName: "[project]/app/book/home/components/GoalMeter.tsx",
                                lineNumber: 60,
                                columnNumber: 13
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "mt-4 h-1.5 w-full overflow-hidden rounded-full bg-slate-800/70",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                className: "mt-4 rounded-xl border border-white/10 bg-white/4 px-3 py-2 text-xs leading-5 text-slate-400",
                children: "Goal progress uses tracked active reading time while the chapter is visible and you are actively engaged."
            }, void 0, false, {
                fileName: "[project]/app/book/home/components/GoalMeter.tsx",
                lineNumber: 78,
                columnNumber: 7
...
_c = GoalMeter;
var _c;
__turbopack_context__.k.register(_c, "GoalMeter");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/app/book/home/components/BookMiniCard.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function BookMiniCard({ book, progress, onOpen }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
        type: "button",
        onClick: onOpen,
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$components$2f$BookCover$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BookCover"], {
                        ...
                        fileName: "[project]/app/book/home/components/BookMiniCard.tsx",
                        lineNumber: 33,
                        columnNumber: 9
                    }, this),
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                        ...
                        children: statusLabel[progress.status]
                    }, void 0, false, {
                        fileName: "[project]/app/book/home/components/BookMiniCard.tsx",
                        lineNumber: 42,
                        columnNumber: 9
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                ...
                children: progress.chapter > 0 ? `Chapter ${progress.chapter} of ${progress.totalChapters}` : `${progress.totalChapters} chapters`
            }, void 0, false, {
                fileName: "[project]/app/book/home/components/BookMiniCard.tsx",
                lineNumber: 54,
                columnNumber: 7
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "mt-3 h-2 overflow-hidden rounded-full bg-slate-900/45",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_c = BookMiniCard;
var _c;
__turbopack_context__.k.register(_c, "BookMiniCard");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/app/book/home/components/InfoModal.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function InfoModal({ open, title, onClose, children }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        "aria-label": title,
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "w-full max-w-lg rounded-3xl border border-white/12 bg-[#0b1120] p-5 shadow-[0_25px_60px_rgba(2,6,23,0.62)]",
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                            ...
                            fileName: "[project]/app/book/home/components/InfoModal.tsx",
                            lineNumber: 25,
                            columnNumber: 11
                        }, this),
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
...
"[project]/app/book/home/BookHomeClient.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$hooks$2f$useBadgeSystem$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/book/hooks/useBadgeSystem.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$hooks$2f$useBookState$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/book/hooks/useBookState.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$hooks$2f$useKeyboardShortcut$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/book/hooks/useKeyboardShortcut.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$hooks$2f$useSavedBooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/book/hooks/useSavedBooks.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$badges$2f$components$2f$BadgeSystemCards$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/book/badges/components/BadgeSystemCards.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$home$2f$components$2f$TopNav$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/book/home/components/TopNav.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$home$2f$components$2f$CurrentlyReadingCard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/book/home/components/CurrentlyReadingCard.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$home$2f$components$2f$TodaySessionCard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/book/home/components/TodaySessionCard.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$home$2f$components$2f$GoalMeter$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/book/home/components/GoalMeter.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$home$2f$components$2f$BookMiniCard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/book/home/components/BookMiniCard.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$home$2f$components$2f$InfoModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/book/home/components/InfoModal.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
;
;
function chapterFromResume(snapshot) {
    const chapter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$data$2f$mockChapters$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBookChaptersBundle"])(snapshot.book.id).chapters.find((entry)=>entry.id === snapshot.resumeChapterId);
    return chapter?.order ?? 1;
}
function mapSnapshotToRecentProgress(snapshot) {
    return {
        bookId: snapshot.book.id,
        status: snapshot.status,
        progressPercent: snapshot.progressPercent,
        chapter: snapshot.status === "completed" ? snapshot.totalChapters : chapterFromResume(snapshot),
        resumeChapterId: snapshot.resumeChapterId,
        totalChapters: snapshot.totalChapters,
        lastOpenedAt: snapshot.lastOpenedLabel
    };
}
function BookHomeClient() {
    _s();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    ...
    const [showQuickReviewModal, setShowQuickReviewModal] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const { state: onboarding, hydrated: onboardingHydrated } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$hooks$2f$useOnboardingState$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useOnboardingState"])();
    const dashboard = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$hooks$2f$useBookState$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBookState"])({
        selectedBookIds: onboarding.selectedBookIds,
        dailyGoalMinutes: onboarding.dailyGoalMinutes
    });
    const { saved, hydrated: savedHydrated } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$hooks$2f$useSavedBooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSavedBooks"])(onboarding.setupComplete);
    const badgeSystem = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$hooks$2f$useBadgeSystem$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBadgeSystem"])({
        selectedBookIds: onboarding.selectedBookIds,
        dailyGoalMinutes: onboarding.dailyGoalMinutes
    });
    const { analytics } = badgeSystem;
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$hooks$2f$useKeyboardShortcut$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useKeyboardShortcut"])("/", {
        "BookHomeClient.useKeyboardShortcut": (event)=>{
            event.preventDefault();
            searchInputRef.current?.focus();
        }
    }["BookHomeClient.useKeyboardShortcut"], {
        ignoreWhenTyping: true
    });
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BookHomeClient.useEffect": ()=>{
    ...
    const recentBooks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BookHomeClient.useMemo[recentBooks]": ()=>{
            if (!analytics) {
                return dashboard.state.recentBooks.map({
                    "BookHomeClient.useMemo[recentBooks]": (progress)=>{
                        const book = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$data$2f$booksCatalog$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBookById"])(progress.bookId);
                        return book ? {
                            book,
                            progress
                        } : null;
                    }
                }["BookHomeClient.useMemo[recentBooks]"]).filter({
                    "BookHomeClient.useMemo[recentBooks]": (entry)=>Boolean(entry)
                }["BookHomeClient.useMemo[recentBooks]"]);
            }
            const selectedSet = new Set(onboarding.selectedBookIds);
            const selectedOrder = new Map(onboarding.selectedBookIds.map({
                "BookHomeClient.useMemo[recentBooks]": (bookId, index)=>[
                        bookId,
                        index
                    ]
            }["BookHomeClient.useMemo[recentBooks]"]));
            const ordered = [
                ...
                "BookHomeClient.useMemo[recentBooks].ordered": (left, right)=>{
                    const leftSelected = selectedSet.has(left.book.id);
                    const rightSelected = selectedSet.has(right.book.id);
                    if (leftSelected !== rightSelected) return leftSelected ? -1 : 1;
                    if (leftSelected && rightSelected) {
                        return (selectedOrder.get(left.book.id) ?? Number.MAX_SAFE_INTEGER) - (selectedOrder.get(right.book.id) ?? Number.MAX_SAFE_INTEGER);
                    }
            ...
            }["BookHomeClient.useMemo[recentBooks].ordered"]);
            return ordered.map({
                "BookHomeClient.useMemo[recentBooks]": (snapshot)=>({
                        book: snapshot.book,
        ...
        analytics,
        dashboard.state.recentBooks,
        onboarding.selectedBookIds
    ]);
    const currentEntry = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BookHomeClient.useMemo[currentEntry]": ()=>{
            const byId = recentBooks.find({
                "BookHomeClient.useMemo[currentEntry].byId": (entry)=>entry.progress.bookId === dashboard.state.currentBookId
            }["BookHomeClient.useMemo[currentEntry].byId"]);
            return byId || recentBooks[0] || null;
        }
    }["BookHomeClient.useMemo[currentEntry]"], [
        dashboard.state.currentBookId,
        recentBooks
    ]);
    ...
    const filteredRecentBooks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BookHomeClient.useMemo[filteredRecentBooks]": ()=>{
            if (!searchQuery) return recentBooks;
            return recentBooks.filter({
                "BookHomeClient.useMemo[filteredRecentBooks]": ({ book })=>{
                    const searchable = `${book.title} ${book.author} ${book.category}`.toLowerCase();
    ...
    const savedBooksPreview = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BookHomeClient.useMemo[savedBooksPreview]": ()=>{
            return saved.map({
                "BookHomeClient.useMemo[savedBooksPreview]": (item)=>{
                    const book = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$data$2f$booksCatalog$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBookById"])(item.bookId);
                    if (!book) return null;
                    const progress = recentBooks.find({
                        "BookHomeClient.useMemo[savedBooksPreview]": (entry)=>entry.book.id === item.bookId
                    }["BookHomeClient.useMemo[savedBooksPreview]"])?.progress ?? {
                        bookId: item.bookId,
                        status: "not_started",
                        progressPercent: 0,
                        chapter: 1,
                        resumeChapterId: "",
                        totalChapters: (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$data$2f$mockChapters$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBookChaptersBundle"])(item.bookId).chapters.length || 1,
            ...
            }["BookHomeClient.useMemo[savedBooksPreview]"]).filter({
                "BookHomeClient.useMemo[savedBooksPreview]": (entry)=>Boolean(entry)
            }["BookHomeClient.useMemo[savedBooksPreview]"]).slice(0, 3);
        }
    }["BookHomeClient.useMemo[savedBooksPreview]"], [
        recentBooks,
        saved
    ]);
    const dailyInsight = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BookHomeClient.useMemo[dailyInsight]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$data$2f$mockProgress$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildDailyInsight"])(currentBook?.title || "your current book")
    }["BookHomeClient.useMemo[dailyInsight]"], [
        currentBook?.title
    ]);
    const showStickyContinue = Boolean(currentProgress) && currentProgress?.status !== "completed" && !dashboard.state.dismissMobileCta;
    const sessionRoute = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BookHomeClient.useMemo[sessionRoute]": ()=>{
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    fileName: "[project]/app/book/home/BookHomeClient.tsx",
                    lineNumber: 188,
                    columnNumber: 9
                }, this),
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "pointer-events-none absolute inset-0 -z-10 bg-[radial-gradient(920px_circle_at_10%_-6%,rgba(56,189,248,0.12),transparent_58%),radial-gradient(860px_circle_at_100%_0%,rgba(251,191,36,0.08),transparent_52%)]"
                }, void 0, false, {
                    fileName: "[project]/app/book/home/BookHomeClient.tsx",
                    lineNumber: 189,
                    columnNumber: 9
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "mx-auto w-full max-w-7xl animate-pulse px-4 pb-16 pt-10 sm:px-6",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "h-11 w-72 rounded-xl bg-slate-800/60"
                        }, void 0, false, {
                            fileName: "[project]/app/book/home/BookHomeClient.tsx",
                            lineNumber: 191,
                            columnNumber: 11
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "mt-3 h-6 w-56 rounded-xl bg-slate-800/40"
                        }, void 0, false, {
                            fileName: "[project]/app/book/home/BookHomeClient.tsx",
                            lineNumber: 192,
                            columnNumber: 11
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "mt-6 grid grid-cols-1 gap-4 lg:grid-cols-[1.55fr_1fr]",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "h-72 rounded-3xl bg-slate-800/50"
                                }, void 0, false, {
                                    fileName: "[project]/app/book/home/BookHomeClient.tsx",
                                    lineNumber: 194,
                                    columnNumber: 13
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "h-72 rounded-3xl bg-slate-800/40"
                                }, void 0, false, {
                                    fileName: "[project]/app/book/home/BookHomeClient.tsx",
                                    lineNumber: 195,
                                    columnNumber: 13
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "h-28 rounded-3xl bg-slate-800/40 lg:col-span-2"
                                }, void 0, false, {
                                    fileName: "[project]/app/book/home/BookHomeClient.tsx",
                                    lineNumber: 198,
                                    columnNumber: 13
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "h-28 rounded-3xl bg-slate-800/40"
                                }, void 0, false, {
                                    fileName: "[project]/app/book/home/BookHomeClient.tsx",
                                    lineNumber: 199,
                                    columnNumber: 13
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "pointer-events-none absolute inset-0 -z-10 bg-[radial-gradient(980px_circle_at_8%_-8%,rgba(56,189,248,0.12),transparent_58%),radial-gradient(820px_circle_at_100%_0%,rgba(251,191,36,0.08),transparent_52%)]"
            }, void 0, false, {
                fileName: "[project]/app/book/home/BookHomeClient.tsx",
                lineNumber: 209,
                columnNumber: 7
            }, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$home$2f$components$2f$TopNav$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TopNav"], {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: analytics && analytics.streakDays > 0 ? `You're on a ${analytics.streakDays}-day streak. Keep it up.` : "Start your first chapter and your reading streak will begin here."
                                    }, void 0, false, {
                                        fileName: "[project]/app/book/home/BookHomeClient.tsx",
                                        lineNumber: 225,
                                        columnNumber: 13
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: "inline-flex items-center gap-2 rounded-full border border-amber-300/35 bg-amber-300/14 px-3.5 py-1.5 text-sm font-medium text-amber-100",
                                children: [
                                    ...
                                    (analytics?.streakDays ?? 0) > 0 ? `${analytics?.streakDays ?? 0} day streak` : "No streak yet"
                                ]
                            }, void 0, true, {
                                fileName: "[project]/app/book/home/BookHomeClient.tsx",
                                lineNumber: 231,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "mt-7 grid grid-cols-1 gap-4 lg:grid-cols-[1.55fr_1fr]",
                        children: [
                            currentBook && currentProgress ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$home$2f$components$2f$CurrentlyReadingCard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CurrentlyReadingCard"], {
                                book: currentBook,
                                ...
                                className: "rounded-[30px] border border-white/10 bg-white/3 p-6 text-slate-300",
                                children: "Finish onboarding to unlock your first book and start reading."
                            }, void 0, false, {
                                fileName: "[project]/app/book/home/BookHomeClient.tsx",
                                lineNumber: 251,
                                columnNumber: 13
                            }, this),
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$home$2f$components$2f$TodaySessionCard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TodaySessionCard"], {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("article", {
                                className: "rounded-3xl border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.08),rgba(255,255,255,0.03))] p-5 lg:col-span-2",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "flex items-center gap-2",
                                        children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "mt-3 border-l-2 border-amber-400/40 pl-3 text-base leading-relaxed text-slate-200",
                                        children: dailyInsight.takeaway
                                    }, void 0, false, {
                                        fileName: "[project]/app/book/home/BookHomeClient.tsx",
                                        lineNumber: 272,
                                        columnNumber: 13
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$home$2f$components$2f$GoalMeter$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GoalMeter"], {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "mt-4 rounded-3xl border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.07),rgba(255,255,255,0.03))] p-5",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "mt-3 grid grid-cols-1 gap-2.5 md:grid-cols-3",
                                children: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$data$2f$mockProgress$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["QUICK_REVIEW_PROMPTS"].map((prompt)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        type: "button",
                                        onClick: ()=>setShowQuickReviewModal(true),
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: "mb-1 block text-[10px] font-semibold uppercase tracking-[0.12em] text-sky-400/55 group-hover:text-sky-400/80",
                                                children: "Reflect"
                                            }, void 0, false, {
                                                fileName: "[project]/app/book/home/BookHomeClient.tsx",
                                                lineNumber: 303,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                ...
                                                children: saved.length > 0 ? `${saved.length} saved book${saved.length === 1 ? "" : "s"} ready when you are.` : "Save books from the library and they will appear here."
                                            }, void 0, false, {
                                                fileName: "[project]/app/book/home/BookHomeClient.tsx",
                                                lineNumber: 314,
                                                columnNumber: 15
                            ...
                            savedBooksPreview.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3",
                                children: savedBooksPreview.map(({ book, progress })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$home$2f$components$2f$BookMiniCard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BookMiniCard"], {
                                        book: book,
                                        progress: progress,
                                ...
                                className: "rounded-3xl border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.07),rgba(255,255,255,0.03))] p-5 text-slate-300",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "text-base text-slate-200",
                                        children: "No saved books yet."
                                    }, void 0, false, {
                                        fileName: "[project]/app/book/home/BookHomeClient.tsx",
                                        lineNumber: 338,
                                        columnNumber: 15
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: "Use the bookmark control in the library to build a reading queue you can return to quickly."
                                    }, void 0, false, {
                                        fileName: "[project]/app/book/home/BookHomeClient.tsx",
                                        lineNumber: 339,
                                        columnNumber: 15
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: filteredRecentBooks.slice(0, 5).map(({ book, progress })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$home$2f$components$2f$BookMiniCard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BookMiniCard"], {
                                        book: book,
                                        progress: progress,
                                        onOpen: ()=>{
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$badges$2f$components$2f$BadgeSystemCards$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DashboardAchievementWidget"], {
            ...
            showStickyContinue && currentProgress ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "fixed bottom-20 left-4 right-4 z-50 md:hidden",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "flex items-center gap-2 rounded-2xl border border-sky-300/35 bg-[#0b1324]/95 p-2 shadow-[0_16px_32px_rgba(2,6,23,0.5)] backdrop-blur",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            type: "button",
                            onClick: ()=>{
                            ...
                            children: currentProgress.status === "not_started" ? `Start Chapter ${currentProgress.chapter} →` : `Continue Chapter ${currentProgress.chapter} →`
                        }, void 0, false, {
                            fileName: "[project]/app/book/home/BookHomeClient.tsx",
                            lineNumber: 393,
                            columnNumber: 13
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$home$2f$components$2f$InfoModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InfoModal"], {
                open: Boolean(selectedBadge),
                title: selectedBadge?.name || "Badge",
                onClose: ()=>setSelectedBadge(null),
                children: selectedBadge ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$badges$2f$components$2f$BadgeSystemCards$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BadgeDetailPanel"], {
                    badge: selectedBadge,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$home$2f$components$2f$InfoModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InfoModal"], {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        children: "We'll add interactive flashcards and spaced repetition prompts so your key ideas stick over time."
                    }, void 0, false, {
                        fileName: "[project]/app/book/home/BookHomeClient.tsx",
                        lineNumber: 435,
                        columnNumber: 9
...
_s(BookHomeClient, "sLh09L4fuT2rxuQcSmSTYIn+yxQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$hooks$2f$useBookState$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBookState"],
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$hooks$2f$useSavedBooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSavedBooks"],
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$hooks$2f$useBadgeSystem$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBadgeSystem"],
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$book$2f$hooks$2f$useKeyboardShortcut$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useKeyboardShortcut"]
    ];
});
_c = BookHomeClient;
var _c;
__turbopack_context__.k.register(_c, "BookHomeClient");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=app_17548209._.js.map